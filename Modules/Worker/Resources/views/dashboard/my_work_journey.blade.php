            ...
            <div class="ss-job-apply-on-view-detls-mn-dv ss-my-wrk-apply-mn-sec">
                <div class="ss-job-apply-on-tx-bx-hed-dv">
                    <ul>
                        ...
                        <li><img src="{{ URL::asset('images/nurses/profile/' . $model->recruiter->image) }}"
                                onerror="this.onerror=null;this.src='{{ USER_IMG }}';" />{{ $model->recruiter->first_name . ' ' . $model->recruiter->last_name }}
                        </li>
                    </ul>
            ...
            <div class="ss-job-apply-on-view-detls-mn-dv ssmy-jorey-offred-mn-sec">
                ...
                <p>?</p>
                    ...
                    <div class="ss-job-apl-on-offer-btn">
                        ...
                        <ul>
                            <li><button type="button" class="ss-counter-btn" data-id="{{ $model->id }}"
                                    data-type="counter" onclick="fetch_job_content(this)">Counter offer</button></li>
