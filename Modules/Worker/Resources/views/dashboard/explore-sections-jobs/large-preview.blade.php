@forelse($jobs as $j)
    <div class="ss-job-prfle-sec job-item" onclick="redirectToJobDetails(`{{ $j->id }}`)"
        data-job="{{ $j->id }}" data-id="{{ $j->id }}" style="margin-left: 0px; margin-top: 20px;">
        {{-- row 1 --}}
                ...
                <div class="col-7">
                    <ul>
                        @if (isset($j->profession) && isset($j->preferred_specialty))
                            <li>
                                <svg style="vertical-align: text-top;" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16">
                                    <path
                        ...
                        @elseif(isset($j->profession))
                            <li><svg style="vertical-align: text-top;" xmlns="http://www.w3.org/2000/svg" width="16"
                                    height="16" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16">
                                    <path
                                        d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v8A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-8A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5m1.886 6.914L15 7.151V12.5a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5V7.15l6.614 1.764a1.5 1.5 0 0 0 .772 0M1.5 4h13a.5.5 0 0 1 .5.5v1.616L8.129 7.948a.5.5 0 0 1-.258 0L1 6.116V4.5a.5.5 0 0 1 .5-.5" />
                                </svg>
                ...
                <div class="col-6 d-flex justify-content-between justify-content-md-start ">
                    <ul>
                        @if ($j->preferred_shift_duration == '5x8 Days' || $j->preferred_shift_duration == '4x10 Days')
                            <li>
                                <svg style="vertical-align: bottom;" xmlns="http://www.w3.org/2000/svg" width="25"
                                    height="25" fill="currentColor" class="bi bi-brightness-alt-high-fill"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        @elseif ($j->preferred_shift_duration == '3x12 Nights or Days')
                            <li>
                                <svg style="vertical-align: text-bottom;" xmlns="http://www.w3.org/2000/svg"
                                    width="20" height="16" fill="currentColor" class="bi bi-moon-stars"
                                    viewBox="0 0 16 16">
                                    <path
