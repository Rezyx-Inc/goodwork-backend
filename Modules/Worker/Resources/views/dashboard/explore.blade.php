            ...
            <div class="ss-dash-profile-jb-mn-dv">
              ...
              <div class="ss-dash-profile-4-bx-dv">
                ...
                <div class="ss-job-prfle-sec" onclick="redirectToJobDetails(`{{$j->id}}`)">
                    ...
                    <p class="col-2 text-center" style="padding-right:20px;"><span>+{{$j->getOfferCount()}} Applied</span></p>
                    </div>
                    {{-- row 2 --}}
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-5 d-flex justify-content-end">
                            <ul>
                                ...
                                <li><a href="#"><img class="icon_cards" src="{{URL::asset('frontend/img/calendar.png')}}"> {{$j->hours_per_week}} hrs/wk</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 d-flex justify-content-end">
                            <ul>
                                ...
                                <li><img class="icon_cards" src="{{URL::asset('frontend/img/dollarcircle.png')}}"> {{ number_format($j->actual_hourly_rate, 2) }}/hr</li>
                                <li><img class="icon_cards" src="{{URL::asset('frontend/img/dollarcircle.png')}}"> {{ number_format($j->weekly_pay) }}/wk</li>
                                <li style="font-weight: 600;"><img class="icon_cards" src="{{URL::asset('frontend/img/dollarcircle.png')}}"> {{ number_format($j->weekly_pay * 4 * 12) }}/yr</li></ul>
                        </div>
                    </div>
                    ...
                    <a href="javascript:void(0)" data-id="{{$j->id}}" onclick="save_jobs(this, event)" class="ss-jb-prfl-save-ico">
