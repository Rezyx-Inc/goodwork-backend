                ...
                <div class="row">
                    <div class="col-lg-5 ss-displ-flex">
                        <div class="ss-mywrk-jrny-left-dv">
                            ...
                            <!-------->
                            @forelse($jobs as $k=>$j)
                                <div class="ss-job-prfle-sec job-list" data-id="{{ $j->id }}"
                                    data-type="{{ $type }}" onclick="fetch_job_content(this)">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#"><img src="{{ URL::asset('frontend/img/dollarcircle.png') }}">
                                                ${{ $j->weekly_pay }}/wk</a></li>
                                    </ul>
                                    <h5>Recently Added</h5>
                                    @if ($type == 'saved')
                                        <a href="javascript:void(0)" data-id="{{ $j->id }}"
                                            onclick="save_jobs(this, true)" class="ss-jb-prfl-save-ico"><img
                                                src="{{ URL::asset('frontend/img/bookmark.png') }}" /></a>
                                    @endif
                                </div>
                            @empty
                            @endforelse
            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <h3 class="col-6">Payment Method</h3>
                    </div>
                    <div class="modal-body" style="padding:0px !important;">

                        <div class="ss-prsn-form-btn-sec row col-12 d-flex justify-content-center align-items-center">
