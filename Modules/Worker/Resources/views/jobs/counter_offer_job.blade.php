...
<div class="ss-counter-ofred-mn-div">
  ...
  <div class="ss-job-view-off-text-fst-dv">
      <p>On behalf of <a href="">{{$recruiter->first_name}} , {{$recruiter->last_name}}</a> would like to offer <a href="#">{{$model->job_id}}</a> to <a href="#">James Bond</a> with the following terms. This offer is only available for the next <a hre="#">6 weeks:</a></p>
  </div>
