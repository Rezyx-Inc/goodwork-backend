...
<div id="{{$data['OrganizationId']}}" class="ss-job-prfle-sec cards"  onclick="toggleActiveClass('{{$data['OrganizationId']}}'); getOffersOfEachOrganization('{{$data['type']}}','{{ $data['OrganizationId'] }}')">
        <div class="ss-job-id-no-name">
            <ul>
                <li class="w-50">
                    <span class="mb-3">{{ $data['OrganizationId'] }}</span>
                </li>
                <li class="w-50">
        ...
        <ul>
            ...
            <li>
                <h6 class="job-title">{{ $data['organization_name'] }}</h6>
            </li>
        </ul>
