        ...
        if ($request->ajax()) {
            ...
            if ($validator->fails()) {
                ...
                */
                ...
                $input["organization_weekly_amount"] = isset($request->organization_weekly_amount) ? $request->organization_weekly_amount : '';
                $input["goodwork_weekly_amount"] = isset($request->goodwork_weekly_amount) ? $request->goodwork_weekly_amount : '';
                $input["total_organization_amount"] = isset($request->total_organization_amount) ? $request->total_organization_amount : '';
                ...
                $input["organization_average_rating"] = isset($request->organization_average_rating) ? $request->organization_average_rating : '';
