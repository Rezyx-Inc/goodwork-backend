        ...
        $('#listing-table').DataTable({
            ...
            columns: [
                ...
                { data: 'status', name: 'status',  render: function (data, type, row) {
                            if (data == '0') {
                                return '<span class="label label-sm text-warning">Open</span>';
                            } else if (data == '1') {
                                return '<span class="label label-sm text-info">In-progress</span>';
                            } else if (data == '2') {
                                return '<span class="label label-sm text-success">Closed</span>';
                            }  else {
                                return '';
                            }
                        }
