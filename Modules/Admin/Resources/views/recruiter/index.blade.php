                        ...
                        <div class="card-box table-responsive">
                            <div class="row float-right">
                                <div class="col-md-12 col-sm-12 d-flex justify-content-start">
                                    <a class="btn btn-success" href="{{ route('recruiters.create') }}">Add New</a>
...
<div class="ss-dsh-workr-pg-mn-dv ss-dsh-rol-pg-mn-dv">
  ...
  <button type="button" class="ssbtn">
    <i class="fa fa-search" aria-hidden="true"></i>
                        ...
                        <li><button class="ss-add-role-btn" data-toggle="modal" data-target="#exampleModal">Add Recruiter</button></li>
  ...
  <tbody>
   ...
   <td>
       <div class="ss-recru-tbl-fac-dv">
           <a href="#">Abc Healthcare <span>Hospital</span></a>
       </div>
   </td>
   <td><button class="ss-recru-active-btn">Active</button></td>
   ...
   <td><button class="ss-recru-inactive-btn">Inactive</button></td>
   <td>10/10/2023 07:37 AM</td>
    </tr>
