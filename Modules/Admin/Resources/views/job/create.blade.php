        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="create-job-form" method="post" action="{{ route('jobs.store') }}" data-parsley-validate
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select name="country" id="country" class="form-control" onchange="get_states(this)"
                                        required="required">
                                        @foreach ($countries as $c)
                                            <option value="{{ $c->id }}" {{ $usa->id ?: '' }}>{{ $c->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select name="profession" onchange="get_speciality(this)" class="form-control">
                                        ...
                                        @foreach ($professions as $v)
                                            <option value="{{ $v->title }}" data-id="{{ $v->id }}">
                                                {{ $v->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <label class="col-form-label label-align"> Compact <input type="checkbox"
                                            class="fomm-control" value="1" name="compact"></label>
                                </div>
                            </div>


                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Vaccination & Immunization
                                    :</label>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <textarea class="resizable_textarea form-control" id="skills" name="skills" placeholder="Skills"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> # Of Positions
                                    Available</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="position_available" class="form-control"
                                        placeholder="2 of 3" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="vms" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> # Of Submissions In
                                    VMS</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="submission_of_vms" class="form-control"
                                        placeholder="Not Available" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="block_scheduling" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="float_requirement" class="form-control"
                                        placeholder="Float Requirements" />
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Facility Shift Cancellation
                                    Policy</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="facility_shift_cancelation_policy" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Contract termination
                                    policy</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="contract_termination_policy" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Traveler Distance from
                                    Facility</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="traveler_distance_from_facility" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Facility's Parent
                                    System</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="facilitys_parent_system" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Facility Average
                                    Rating</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="facility_average_rating" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Recruiter Average
                                    Rating</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="recruiter_average_rating" class="form-control"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"> Organization Average
                                    Rating</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="organization_average_rating" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="clinical_setting" class="form-control"
                                        placeholder="School" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="Patient_ratio" class="form-control"
                                        placeholder="Available Upon Request" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="emr" class="form-control"
                                        placeholder="Not Available" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="Trauma_Level" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="scrub_color" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="guaranteed_hours" class="form-control"
                                        placeholder="0" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="preferred_assignment_duration" class="form-control"
                                        placeholder="13" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="sign_on_bonus" class="form-control"
                                        placeholder="1000" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="completion_bonus" class="form-control"
                                        placeholder="5000" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="extension_bonus" class="form-control"
                                        placeholder="1000" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="other_bonus" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="four_zero_one_k" class="form-control"
                                        placeholder="Enter 401K" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="health_insaurance" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="dental" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="actual_hourly_rate" class="form-control"
                                        placeholder="28" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="feels_like_per_hour" class="form-control"
                                        placeholder="28" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" name="on_call" class="form-control"
                                        placeholder="Enter On Call" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="orientation_rate" class="form-control"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="weekly_taxable_amount" class="form-control"
                                        placeholder="1001" />
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Weekly Non-Taxable Amount($)
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="weekly_non_taxable_amount" class="form-control"
                                        placeholder="1009" />
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Organization Weekly Amount($)
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="organization_weekly_amount" class="form-control"
                                        placeholder="2100" />
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Goodwork Weekly Amount($)
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="goodwork_weekly_amount" class="form-control"
                                        placeholder="105" />
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Total Organization Amount($)
                                </label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="total_organization_amount" class="form-control"
                                        placeholder="33,300" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="total_goodwork_amount" class="form-control"
                                        placeholder="1,365" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="number" name="total_contract_amount" class="form-control"
                                        placeholder="34,665" />
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <textarea id="description" class="resizable_textarea form-control" name="description" placeholder="Description"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-4 col-sm-4 ">
                                    <input class="date-picker form-control" name="start_date" placeholder="dd-mm-yyyy"
                                ...
                                <div class="col-md-2 col-sm-2">
                                    <label class="col-form-label label-align"> As Soon As <input type="checkbox"
                                            class="fomm-control" value="1" name="as_soon_as"></label>
                                </div>
                            </div>
                    ...
                    error: function(resp) {
                        ...
                        if (resp.responseJSON && resp.responseJSON.errors) {
                            ...
                            $.each(errors, function(field, messages) {
                                ...
                                var inputElement = $('#create-job-form').find(
                                    '[name="' + field + '"]');
