...
<div class="">
    ...
    <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#offers" role="tab" aria-controls="offers"
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <form id="create-job-form" method="post"
                                action="{{route('jobs.update',['id'=>$model->id])}}" data-parsley-validate
                                class="form-horizontal form-label-left">
                                @method('PATCH')
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Job Name <span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" required="required" value="{{$model->job_name}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="type" class="form-control" required="required">
                                            ...
                                            @foreach($types as $v)
                                            <option value="{{$v->title}}" {{ ($model->type == $v->title) ? 'selected'
                                                :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Terms <span
                                            class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="terms" class="form-control" required="required">
                                            <option value="">Select</option>
                                            @foreach($terms as $v)
                                            <option value="{{$v->title}}" {{ ($model->terms == $v->title) ? 'selected'
                                                :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="recruiter_id" class="form-control">
                                            ...
                                            <option value="{{$v->id}}" {{ ($model->recruiter_id == $v->id) ? 'selected'
                                                :'' }}>{{$v->first_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="country" id="country" class="form-control"
                                            onchange="get_states(this)" required="required">
                                            @foreach($countries as $c)
                                            <option value="{{$c->id}}" {{ ($usa->id == $c->id) ? 'selected': ''
                                                }}>{{$c->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Professional Licensure
                                    </label>
                                    <div class="col-md-4 col-sm-4">
                                        <select name="job_location" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($us_states as $v)
                                            <option value="{{$v->id}}" {{ ($model->job_location == $v->id) ? 'selected'
                                                :'' }}>{{$v->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-2">
                                        <label class="col-form-label label-align"> Compact <input type="checkbox"
                                                class="fomm-control" value="1" name="compact" {{ ($model->compact ==
                                            '1') ? 'checked': '' }}></label>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-5 col-sm-5">
                                        <input name="vaccinations" id="vaccination" class="form-control"
                                            placeholder="Vaccination & Immunization Name" />
                                    </div>
                                    <div class="col-md-1 col-sm-1">
                                        <button type="button" data-type="vac" onclick="add_element(this)"><i
                                                class="fa fa-plus"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> </label>
                                    <div class="col-md-5 col-sm-5">
                                        <input name="certificate" id="certificate" class="form-control"
                                            placeholder="Certificate Name" />
                                    </div>
                                    <div class="col-md-1 col-sm-1">
                                        <button type="button" data-type="cer" onclick="add_element(this)"><i
                                                class="fa fa-plus"></i></button>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" id="skills" name="skills"
                                            value="{{$model->skills}}" placeholder="Skills" data-role="tagsinput">
                                        {{-- <textarea class="resizable_textarea form-control" id="skills" name="skills"
                                            value="{{$model->skills}}" placeholder="Skills"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="urgency" value="{{$model->urgency}}"
                                            class="form-control" placeholder="Auto Offer" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="position_available"
                                            value="{{$model->position_available}}" class="form-control"
                                            placeholder="2 of 3" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="msp" value="{{$model->msp}}" class="form-control"
                                            placeholder="Right Sourcing" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="vms" value="{{$model->vms}}" class="form-control"
                                            placeholder="Not Available" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> # Of Submissions In
                                        VMS</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="submission_of_vms"
                                            value="{{$model->submission_of_vms}}" class="form-control"
                                            placeholder="Not Available" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Block
                                        Scheduling</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="block_scheduling" value="{{$model->block_scheduling}}"
                                            class="form-control" placeholder="Not Allowed" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Float
                                        Requirements</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="float_requirement"
                                            value="{{$model->float_requirement}}" class="form-control"
                                            placeholder="Float Requirements" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="facility_shift_cancelation_policy"
                                            value="{{$model->facility_shift_cancelation_policy}}" class="form-control"
                                            placeholder="Facility Shift Cancellation Plicy" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Contract termination
                                        policy</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="contract_termination_policy"
                                            value="{{$model->contract_termination_policy}}" class="form-control"
                                            placeholder="Contract termination policy" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Traveler Distance from
                                        Facility</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="traveler_distance_from_facility"
                                            value="{{$model->traveler_distance_from_facility}}" class="form-control"
                                            placeholder="75 miles" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="facility_id" value="{{$model->facility_id}}"
                                            class="form-control" placeholder="Available Upon Request" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="facilitys_parent_system"
                                            value="{{$model->facilitys_parent_system}}" class="form-control"
                                            placeholder="Facility's Parent System" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Facility Average
                                        Rating</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="facility_average_rating"
                                            value="{{$model->facility_average_rating}}" class="form-control"
                                            placeholder="Facility Average Rating" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Recruiter Average
                                        Rating</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="recruiter_average_rating"
                                            value="{{$model->recruiter_average_rating}}" class="form-control"
                                            placeholder="Recruiter Average Rating" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Organization Average
                                        Rating</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="organization_average_rating"
                                            value="{{$model->organization_average_rating}}" class="form-control"
                                            placeholder="Organization Average Rating" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Clinical
                                        Setting</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="clinical_setting" value="{{$model->clinical_setting}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="emr" value="{{$model->emr}}" class="form-control"
                                            placeholder="Not Available" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="Bed_Size" value="{{$model->Bed_Size}}"
                                            class="form-control" placeholder="Bed Size" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="Trauma_Level" value="{{$model->Trauma_Level}}"
                                            class="form-control" placeholder="Trauma Level" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="scrub_color" value="{{$model->scrub_color}}"
                                            class="form-control" placeholder="Navy Blue" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input name="rto" type="text" value="{{$model->rto}}" class="form-control"
                                            placeholder="Allowed" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="preferred_shift" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" {{ ($v->title == $model->preferred_shift ) ?
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Guaranteed
                                        Hours</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="guaranteed_hours"
                                            value="{{$model->guaranteed_hours}}" class="form-control" placeholder="0" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="hours_shift" value="{{$model->hours_shift}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="weeks_shift" value="{{$model->weeks_shift}}"
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">
                                        Weeks/Assignment</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="preferred_assignment_duration"
                                            value="{{$model->preferred_assignment_duration}}" class="form-control"
                                            placeholder="13" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Referral
                                        Bonus($)</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="referral_bonus" value="{{$model->referral_bonus}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="sign_on_bonus" value="{{$model->sign_on_bonus}}"
                                            class="form-control" placeholder="1000" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="completion_bonus"
                                            value="{{$model->completion_bonus}}" class="form-control"
                                            placeholder="5000" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Extension
                                        Bonus($)</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="extension_bonus" value="{{$model->extension_bonus}}"
                                            class="form-control" placeholder="1000" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="four_zero_one_k" value="{{$model->four_zero_one_k}}"
                                            class="form-control" placeholder="Enter 401K" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="health_insaurance"
                                            value="{{$model->health_insaurance}}" class="form-control"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="dental" value="{{$model->dental}}" class="form-control"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="vision" value="{{$model->vision}}" class="form-control"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="actual_hourly_rate"
                                            value="{{$model->actual_hourly_rate}}" class="form-control"
                                            placeholder="28" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Feels Like
                                        $/Hour</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="feels_like_per_hour"
                                            value="{{$model->feels_like_per_hour}}" class="form-control"
                                            placeholder="28" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="overtime" value="{{$model->overtime}}"
                                            class="form-control" placeholder="Enter Overtime" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="holiday" value="{{$model->holiday}}"
                                            class="form-control" placeholder="Enter Holiday" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="on_call" value="{{$model->on_call}}"
                                            class="form-control" placeholder="Enter On Call" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Orientation Rate($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="orientation_rate"
                                            value="{{$model->orientation_rate}}" class="form-control"
                                            placeholder="Enter Orientation Rate" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Weekly Taxable Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="weekly_taxable_amount"
                                            value="{{$model->weekly_taxable_amount}}" class="form-control"
                                            placeholder="1001" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="weekly_non_taxable_amount"
                                            value="{{$model->weekly_non_taxable_amount}}" class="form-control"
                                            placeholder="1009" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="organization_weekly_amount"
                                            value="{{$model->organization_weekly_amount}}" class="form-control"
                                            placeholder="2100" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Goodwork Weekly
                                        Amount($) </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="goodwork_weekly_amount"
                                            value="{{$model->goodwork_weekly_amount}}" class="form-control"
                                            placeholder="105" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="total_organization_amount"
                                            value="{{$model->total_organization_amount}}" class="form-control"
                                            placeholder="33,300" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Total Goodwork Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="total_goodwork_amount"
                                            value="{{$model->total_goodwork_amount}}" class="form-control"
                                            placeholder="1,365" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Total Contract Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="total_contract_amount"
                                            value="{{$model->total_contract_amount}}" class="form-control"
                                            placeholder="34,665" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="job_state" id="state" onchange="get_cities(this)"
                                            class="form-control">
                                            <option value="">Select</option>
                                            @foreach($us_states as $v)
                                            <option value="{{$v->id}}" {{ ($v->id == $model->job_state ) ? 'selected':
                                                '' }}>{{$v->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <textarea id="description" class="resizable_textarea form-control"
                                            name="description" placeholder="Description"
                                            maxlength="255">{{$model->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <div class="btn-group" data-toggle="buttons">
                                            <label
                                                class="btn btn-primary {{ ($model->active == '1') ? 'focus active': ''}}"
                                                data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                <input type="radio" name="active" value="1" class="join-btn" {{
                                                    ($model->active == '1') ? 'checked': ''}}> Active
                                            </label>
                                            <label
                                                class="btn btn-secondary {{ ($model->active == '0') ? 'focus active': ''}}"
                                                type="button" data-toggle-class="btn-primary">
                                                <input type="radio" name="active" value="0" class="join-btn" {{
                                                    ($model->active == '0') ? 'checked': ''}}> &nbsp; Inactive &nbsp;
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <input class="date-picker form-control" name="start_date"
                                            value="{{$model->start_date}}" placeholder="dd-mm-yyyy" type="text"
                                    ...
                                    <div class="col-md-2 col-sm-2">
                                        <label class="col-form-label label-align"> As Soon As <input type="checkbox"
                                                class="fomm-control" value="1" name="as_soon_as" {{ ($model->as_soon_as
                                            == '1') ? 'checked': '' }}></label>
                                    </div>
                                </div>
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <form id="job-reference-form" method="post"
                                action="{{route('job-references',['id'=>$model->id])}}" data-parsley-validate
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="number_of_references" class="form-control"
                                            onchange="references(this)">
                                            <option value="">Select</option>
                                            @for($i=1;$i<10;$i++) <option value="{{$i}}" {{($model->number_of_references
                                                == $i) ? 'selected': ''}}>{{$i}}</option>
                                                @endfor
                                        </select>
                                    </div>
                                ...
                                <div class="job-references" id="job-references">
                                    ...
                                    <div class="reference-details">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <select name="old_recency_of_reference[]" id="" class="form-control">
                                                    <option value="Yes" {{( $ref->recency_of_reference == 'Yes') ?
                                                        'selected': ''}}>Yes</option>
                                                    <option value="No" {{( $ref->recency_of_reference == 'No') ?
                                                        'selected': ''}}>No</option>
                                                </select>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                <a href="{{URL::asset('uploads/frontend/jobs/images/'.$ref->image)}}"
