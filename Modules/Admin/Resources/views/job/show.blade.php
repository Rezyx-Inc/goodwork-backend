...
<div class="">
    ...
    <div class="col-md-12">
        ...
        <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#offers" role="tab" aria-controls="offers" aria-selected="false">Offers ({{$model->offers->count()}})</a>
          </li>
        </ul>
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{ (!empty($model->recruiter)) ? $model->recruiter->getFullNameAttribute(): 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            ...
                                            $specialty = [];
                                            $experience = [];
                                            if (!empty($model->preferred_specialty) && !empty($model->preferred_experience)) {
                                    ...
                                    <div class="speciality-content">
                                        ...
                                        <div class="item form-group d-flex justify-content-center">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"></label>
                                            <div class="col-md-1 col-sm-1">
                                                <label class="col-form-label label-align"> {{$i+1}}</label>
                                            </div>
                                            <div class="col-md-3 col-sm-3">
                                                <label class="col-form-label label-align"> {{$specialty[$i]}}</label>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                                <label class="col-form-label label-align">{{$experience[$i]}} (Years) </label>
                                            </div>
                                        </div>
                                        @endfor
                                    </div>
                                    ...
                                    <div class="item form-group d-flex justify-content-center">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <label class="col-form-label label-align"> <b>Name of Vaccination</b></label>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div>
                                        ...
                                        <div class="item form-group d-flex justify-content-center">
                                            ...
                                            <div class="col-md-5 col-sm-5">
                                                <label class="col-form-label label-align"> {{$vaccination[$i]}}</label>
                                            </div>
                                        </div>
                                        @endfor
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->recency_of_reference ? $model->recency_of_reference.' Month' : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group d-flex justify-content-center">
                                        ...
                                        <div class="col-md-5 col-sm-5">
                                            <label class="col-form-label label-align"> <b>Name of Certification</b></label>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div>
                                        ...
                                        <div class="item form-group d-flex justify-content-center">
                                            ...
                                            <div class="col-md-5 col-sm-5">
                                                <label class="col-form-label label-align"> {{$certifications[$i]}}</label>
                                            </div>
                                        </div>
                                        @endfor
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{str_replace(',', ', ', $model->skills) ?? 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->position_available ? $model->position_available: 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->submission_of_vms ? $model->submission_of_vms: 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->block_scheduling ? $model->block_scheduling : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->float_requirement ? $model->float_requirement : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->facility_shift_cancelation_policy ? $model->facility_shift_cancelation_policy : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->contract_termination_policy ? $model->contract_termination_policy : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->traveler_distance_from_facility ? $model->traveler_distance_from_facility : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->facility_id ? $model->facility_id : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->facilitys_parent_system ? $model->facilitys_parent_system : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->facility_average_rating ? $model->facility_average_rating : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->recruiter_average_rating ? $model->recruiter_average_rating : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->employer_average_rating ? $model->employer_average_rating : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->clinical_setting ? $model->clinical_setting : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->Patient_ratio ? $model->Patient_ratio : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->Department ? $model->Department : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->Trauma_Level ? $model->Trauma_Level : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->scrub_color ? $model->scrub_color : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->preferred_shift ? $model->preferred_shift : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->guaranteed_hours ? $model->guaranteed_hours : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->hours_shift ? $model->hours_shift : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->weeks_shift ? $model->weeks_shift : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->preferred_assignment_duration ? $model->preferred_assignment_duration : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->referral_bonus ? $model->referral_bonus : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->sign_on_bonus ? $model->sign_on_bonus : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->completion_bonus ? $model->completion_bonus : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->extension_bonus ? $model->extension_bonus : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->other_bonus ? $model->other_bonus : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->four_zero_one_k ? $model->four_zero_one_k : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->health_insaurance ? $model->health_insaurance : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->actual_hourly_rate ? $model->actual_hourly_rate : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->feels_like_per_hour ? $model->feels_like_per_hour : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->orientation_rate ? $model->orientation_rate : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->weekly_taxable_amount ? $model->weekly_taxable_amount : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->weekly_non_taxable_amount ? $model->weekly_non_taxable_amount : 'N/A'}}</p>
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align">Employer Weekly Amount($)abel</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->employer_weekly_amount ? $model->employer_weekly_amount : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->goodwork_weekly_amount ? $model->goodwork_weekly_amount : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->total_employer_amount ? $model->total_employer_amount : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->total_goodwork_amount ? $model->total_goodwork_amount : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{$model->total_contract_amount ? $model->total_contract_amount : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{ !empty($model->jobState->name) ? $model->jobState->name : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{!empty($model->jobCity->name) ? $model->jobCity->name : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->description ? $model->description : 'N/A'}}</p>
                                        </div>
                                    </div>

                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align">Starting date :</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <p class="show-tag">{{$model->start_date ? Carbon\Carbon::parse($model->start_date)->format('d M Y') : 'N/A'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <p class="show-tag">{{ ($model->active == '1') ? 'Active' : 'Inactive'}}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            ...
                                            <a href="{{route('jobs.edit',['id'=>$model->id])}}" class="btn btn-success">Edit</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="listing-table" class="table table-striped table-bordered bulk_action text-center" style="width:100%">
                                                <button class="text-danger float-right" id="delete" type="button">Delete</button>
                                                <thead>
                                                    <tr>
                                                        <th>
