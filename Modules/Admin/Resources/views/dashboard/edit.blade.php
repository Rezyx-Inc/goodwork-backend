                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3  profile_left">
                      <div class="profile_img avatar-upload">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" id="imagePreview" width="220px" height="220px" src="{{URL::asset('uploads/admin/profile_picture/original/'.$model->image)}}" onerror="this.onerror=null;this.src='{{USER_IMG_ADMIN}}';" alt="Avatar" title="Change the avatar">
                        </div>
