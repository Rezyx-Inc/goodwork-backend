    ...
    <ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="details-tab" data-toggle="tab" href="#details" role="tab" aria-controls="details"
                aria-selected="true">Professional Information</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="required-tab" data-toggle="tab" href="#required" role="tab" aria-controls="required"
                aria-selected="false">Vaccination & Immunization</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="urgency-tab" data-toggle="tab" href="#urgency" role="tab" aria-controls="urgency"
                aria-selected="false">References</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="float-tab" data-toggle="tab" href="#float" role="tab" aria-controls="float"
                                ...
                                <div class="profile_img">
                                    <div id="crop-avatar">
                                        ...
                                        <img class="img-responsive avatar-view"
                                            src="{{URL::asset('images/nurses/profile/'.$model->user->profile_image)}}"
                                            onerror="this.onerror=null;this.src='{{USER_IMG_ADMIN}}';" alt="Avatar"
                                ...
                                <ul class="list-unstyled user_data">
                                    ...
                                    <li class="m-top-xs">
                                        ...
                                        <a href="mailto:{{$model->user->email}}"
                                            target="_blank">{{$model->user->email}}</a>
                                    </li>
                                    <li>
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane active " id="tab_content1"
                                            ...
                                            <ul class="messages">
                                                <li>
                                                    <img src="{{URL::asset('backend/assets/images/img.jpg')}}"
                ...
                <div class="col-md-6">
                    <div class="x_panel" style="height: auto;">
                        ...
                        <div class="x_content" style="display: none;">
                            <br />
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                data-parsley-validate class="form-horizontal form-label-left nurse-edit-profile">
                                @method('PATCH')
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Title
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" value="{{$model->credential_title}}" required="required"
                                            class="form-control" name="credential_title">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="profession" onchange="get_speciality(this)" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" data-id="{{$v->id}}" {{ ($model->profession ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Speciality and
                                        Experience:</label>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-1 col-sm-1">
                                        <button type="button" onclick="add_speciality(this)"><i
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="license_type" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" {{ ($model->license_type == $v->title) ?
                                                'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <select name="nursing_license_state" class="form-control">
                                            ...
                                            <option value="{{$v->id}}" {{ ($model->nursing_license_state == $v->id) ?
                                                'selected' :'' }}>{{$v->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-2">
                                        <label class="col-form-label label-align"> Compact <input type="checkbox"
                                                class="fomm-control" value="1" name="compact_license" {{
                                                ($model->compact_license == '1') ? 'checked': '' }}></label>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="date" value="{{$model->license_expiry_date}}" class="form-control"
                        ...
                        <div class="x_content" style="display: none;">
                            ...
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" value="{{$model->worker_urgency}}" class="form-control"
                                            name="worker_urgency" placeholder="How quickly you can join?">
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> # Of Positions
                                        Available
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" value="{{$model->available_position}}" class="form-control"
                                            name="available_position" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="MSP" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($msps as $v)
                                            <option value="{{$v->title}}" data-id="{{$v->id}}" {{ ($model->MSP ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="VMS" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($vmss as $v)
                                            <option value="{{$v->title}}" data-id="{{$v->id}}" {{ ($model->VMS ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" value="{{$model->submission_VMS}}" class="form-control"
                                            name="submission_VMS" placeholder="">
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Block Scheduling
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="block_scheduling" class="form-control">
                                            <option value="">Select</option>
                                            <option value="yes" {{ ($model->block_scheduling == 'yes') ? 'selected':
                                                ''}}>Yes</option>
                                            <option value="no" {{ ($model->block_scheduling == 'no') ? 'selected':
                                                ''}}>No</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="x_content" style="display: none;">
                            ...
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_patient_ratio}}" class="form-control"
                                            name="worker_patient_ratio" placeholder="How many patients you can handle?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="worker_emr" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($emrs as $v)
                                            <option value="{{$v->title}}" {{ ($model->worker_emr == $v->title) ?
                                                'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_unit}}" class="form-control"
                                            name="worker_unit" placeholder="Fav Unit?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_department}}" class="form-control"
                                            name="worker_department" placeholder="Fav Department?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_bed_size}}" class="form-control"
                                            name="worker_bed_size" placeholder="King size or California Size?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_trauma_level}}" class="form-control"
                                            name="worker_trauma_level" placeholder="Ideal Trauma Level?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_scrub_color}}" class="form-control"
                                            name="worker_scrub_color" placeholder="Fav Scrub Brand?">
                                    </div>
                                </div>


                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Facility City <i
                                            class="fa fa-question" data-toggle="tooltip" data-placement="top"
                                            title="Cities you'd like to work at"></i></label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="worker_facility_city" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($us_cities as $v)
                                            <option value="{{$v->name}}" {{ ($model->worker_facility_city == $v->name) ?
                                                'selected' :'' }}>{{$v->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Facility State Code <i
                                            class="fa fa-question" data-toggle="tooltip" data-placement="top"
                                            title="State you'd like to work at"></i></label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="worker_facility_state_code" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($us_states as $v)
                                            <option value="{{$v->iso2}}" {{ ($model->worker_facility_state_code ==
                                                $v->id) ? 'selected' :'' }}>{{$v->iso2}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="x_content" style="display: none;">
                            ...
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="worker_sign_on_bonus"
                                            value="{{$model->worker_sign_on_bonus}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Completion
                                        Bonus($)</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_completion_bonus"
                                            value="{{$model->worker_completion_bonus}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Extension
                                        Bonus($)</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_extension_bonus"
                                            value="{{$model->worker_extension_bonus}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="worker_other_bonus"
                                            value="{{$model->worker_other_bonus}}" class="form-control"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="how_much_k" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" {{ ($model->how_much_k == $v->title) ?
                                                'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Health Insurance
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worker_health_insurance" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($insurances as $v)
                                            <option value="{{$v->title}}" {{ ($model->worker_health_insurance ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worker_dental" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" {{ ($model->worker_dental == $v->title) ?
                                                'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worker_vision" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" {{ ($model->worker_vision == $v->title) ?
                                                'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Actual Hourly
                                        Rate($)</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_actual_hourly_rate"
                                            value="{{$model->worker_actual_hourly_rate}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Feels Like
                                        $/Hour</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_feels_like_hour"
                                            value="{{$model->worker_feels_like_hour}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="x_panel" style="height:auto;">
                        ...
                        <div class="x_content" style="display:none;">
                            ...
                            <form id="skills-form" method="post" action="{{route('worker-skills',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <select name="diploma_cer" class="form-control" data-type="diploma-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                            <option value="Yes" {{ (!empty($diplomaCer)) ? 'selected' : '' }}>Yes
                                            </option>
                                ...
                                <div class="diploma-container {{ (empty($diplomaCer)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/diploma/'.$diplomaCer->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                        @else
                                        <div class="col-md-6 col-sm-6">
                                            <input type="file" name="diploma" class="form-control" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="dl_cer" class="form-control" data-type="dl-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                            <option value="Yes" {{ (!empty($driving_license)) ? 'selected' : '' }}>Yes
                                            </option>
                                            <option value="No" {{ (empty($driving_license)) ? 'selected' : '' }}>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="dl-container {{ (empty($driving_license)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/driving_license/'.$driving_license->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-4 col-sm-4 label-align"> Driving License
                                            Expiration Date </label>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="date" class="form-control" name="license_expiration_date"
                                                value="{{ ($driving_license) ? $driving_license->using_date: ''}}">
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Recent Experience
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="recent_experience"
                                            value="{{$model->recent_experience}}" placeholder="Facility Name">
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Worked At Facility
                                        Before? </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worked_at_facility_before" class="form-control">
                                            <option value="">Select</option>
                                            <option value="Yes" {{ ($model->worked_at_facility_before == 'Yes') ?
                                                'selected': ''}}>Yes</option>
                                            <option value="No" {{ ($model->worked_at_facility_before == 'No') ?
                                                'selected': ''}}>No</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="worker_ss_number"
                                            value="{{$model->worker_ss_number}}" placeholder="SS number">
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Eligible To Work In US?
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="eligible_work_in_us" class="form-control">
                                            <option value="">Select</option>
                                            <option value="yes" {{ ($model->eligible_work_in_us == 'yes') ? 'selected':
                                                ''}}>Yes</option>
                                            <option value="no" {{ ($model->eligible_work_in_us == 'no') ? 'selected':
                                                ''}}>No</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group d-flex justify-content-center">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Skills Checklist
                                    </label>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Completion Date
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="date" class="form-control" name="old_completion_date[]"
                                            value="{{$s->using_date}}">
                                    </div>
                                </div>
                                @php
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <a href="{{URL::asset('images/nurses/skill/'.$s->name)}}" target="_blank"
                                            class="btn brn-success" data-toggle="tooltip" data-placement="bottom"
                                            title="View"><i class="fa fa-download"></i>{{$file_name}} </a>
                                    </div>
                                    @else
                                    <div class="col-md-6 col-sm-6">
                                        <input type="file" name="old_skill[]" class="form-control" />
                                ...
                                <div class="item form-group d-flex justify-content-center">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> <a
                                            href="javascript:void(0);" onclick="add_more_skills(this)"> Add More</a>
                                    </label>
                                </div>
                    ...
                    <div class="x_panel" style="height: auto;">
                        ...
                        <div class="x_content" style="display: none;">
                            ...
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Float Requirement
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="float_requirement" class="form-control">
                                            <option value="">Select</option>
                                            <option value="1" {{ ($model->block_scheduling == '1') ? 'selected':
                                                ''}}>Yes</option>
                                            <option value="0" {{ ($model->block_scheduling == '0') ? 'selected': ''}}>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Facility Shift
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="facility_shift_cancelation_policy" class="form-control">
                                            ...
                                            <option value="{{$v->title}}" {{ ($model->facility_shift_cancelation_policy
                                                == $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Contract Termination
                                        Policy </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="contract_termination_policy" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($contract_policies as $v)
                                            <option value="{{$v->title}}" {{ ($model->contract_termination_policy ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Traveller Distance From
                                        Facility
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->distance_from_your_home}}"
                                            class="form-control" name="distance_from_your_home"
                                            placeholder="Where does IRS think you live?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="facilities_you_like_to_work_at" class="form-control">
                                            ...
                                            <option value="{{$v->id}}" {{ ($model->facilities_you_like_to_work_at ==
                                                $v->id) ? 'selected' :'' }}>{{$v->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Worker Facility Parent
                                        System
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_facility_parent_system}}"
                                            class="form-control" name="worker_facility_parent_system"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->avg_rating_by_facilities}}"
                                            class="form-control" name="avg_rating_by_facilities"
                                            placeholder="Your avaerage rating by your facilities?">
                                    </div>
                                </div>


                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Recruiter Average
                                        Rating
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_avg_rating_by_recruiters}}"
                                            class="form-control" name="worker_avg_rating_by_recruiters"
                                            placeholder="Your avaerage rating by yor recruiter?">
                                    </div>
                                </div>


                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align"> Organization Average
                                        Rating
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_avg_rating_by_organizations}}"
                                            class="form-control" name="worker_avg_rating_by_organizations"
                                            placeholder="Your avaerage rating by yor organizations?">
                                    </div>
                                </div>


                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Clinical Setting
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="clinical_setting_you_prefer" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($types as $v)
                                            <option value="{{$v->title}}" {{ ($model->clinical_setting_you_prefer ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="x_content" style="display: none;">
                            ...
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_interview_dates}}"
                                            class="form-control" name="worker_interview_dates"
                                            placeholder="Dates you are available?">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 ">
                                        <input class="date-picker form-control" name="worker_start_date"
                                            value="{{$model->worker_start_date}}" placeholder="dd-mm-yyyy" type="date">

                                    </div>
                                    <div class="col-md-2 col-sm-2">
                                        <label class="col-form-label label-align"> ASAP <input type="checkbox"
                                                class="fomm-control" value="1" name="worker_as_soon_as_posible" {{
                                                ($model->worker_as_soon_as_posible == '1') ? 'checked': '' }}></label>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Shift Time Of Day
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <select name="worker_shift_time_of_day" class="form-control">
                                            <option value="">Select</option>
                                            @foreach($shift_tile_of_day as $v)
                                            <option value="{{$v->title}}" {{ ($model->worker_shift_time_of_day ==
                                                $v->title) ? 'selected' :'' }}>{{$v->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_hours_per_week}}"
                                            class="form-control" name="worker_hours_per_week"
                                            placeholder="Ideal Hours/Week">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Guaranteed Hours
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_guaranteed_hours}}"
                                            class="form-control" name="worker_guaranteed_hours" placeholder="">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Hourse/Shift </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_hours_shift}}" class="form-control"
                                            name="worker_hours_shift" placeholder="Prefered Hourse/Shift">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Weeks/Assigment </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_weeks_assignment}}"
                                            class="form-control" name="worker_weeks_assignment"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_shifts_week}}" class="form-control"
                                            name="worker_shifts_week" placeholder="Ideal Shifts/Week">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Referral Bonus ($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{$model->worker_referral_bonus}}"
                                            class="form-control" name="worker_referral_bonus"
                                            placeholder="# of people refered">
                                    </div>
                                </div>
                    ...
                    <div class="x_panel" style="height: auto;">
                        ...
                        <div class="x_content" style="display: none;">
                            ...
                            <form method="POST" action="{{route('workers.update',['id'=>$model->id])}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worker_overtime" class="form-control">
                                            <option value="">Select</option>
                                            <option value="yes" {{ ($model->worker_overtime == 'yes') ? 'selected':
                                                ''}}>Yes</option>
                                            <option value="no" {{ ($model->worker_overtime == 'no') ? 'selected':
                                                ''}}>No</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="date" name="worker_holiday" value="{{$model->worker_holiday}}"
                                            class="form-control" placeholder="Any holiday you refuse to work?" />
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worker_on_call" class="form-control">
                                            <option value="">Select</option>
                                            <option value="yes" {{ ($model->worker_on_call == 'yes') ? 'selected':
                                                ''}}>Yes</option>
                                            <option value="no" {{ ($model->worker_on_call == 'no') ? 'selected': ''}}>No
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Orientation Rate($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_orientation_rate"
                                            value="{{$model->worker_orientation_rate}}" class="form-control"
                                            placeholder="Enter Orientation Rate" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Weekly Taxable Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_weekly_taxable_amount"
                                            value="{{$model->worker_weekly_taxable_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Weekly Non-Taxable
                                        Amount($) </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_weekly_non_taxable_amount"
                                            value="{{$model->worker_weekly_non_taxable_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Organization Weekly
                                        Amount($) </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_organization_weekly_amount"
                                            value="{{$model->worker_organization_weekly_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Goodwork Weekly
                                        Amount($) </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_goodwork_weekly_amount"
                                            value="{{$model->worker_goodwork_weekly_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Total Organization
                                        Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_total_organization_amount"
                                            value="{{$model->worker_total_organization_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Total Goodwork Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_total_goodwork_amount"
                                            value="{{$model->worker_total_goodwork_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="col-form-label col-md-4 col-sm-4 label-align">Total Contract Amount($)
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" name="worker_total_contract_amount"
                                            value="{{$model->worker_total_contract_amount}}" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <form id="vaccination-form" method="post"
                                action="{{route('worker-vaccination',['id'=>$model->id])}}" data-parsley-validate
                                class="form-horizontal form-label-left" enctype="multipart/form-data">

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Did you get the COVID
                                        Vaccine? </label>
                                    <div class="col-md-6 col-sm-6">

                                        <select name="covid_vac" class="form-control" data-type="covid-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                ...
                                <div class="covid-container {{ (empty($covidVac)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/vaccination/'.$covidVac->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="date"
                                                value="{{ (!empty($covidVac)) ? $covidVac->using_date: null}}"
                                                class="form-control" name="covid_date">
                                        </div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Did you get the Flu
                                        Vaccine? </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="flu_vac" class="form-control" data-type="flu-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                ...
                                <div class="flu-container {{ (empty($fluVac)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/vaccination/'.$fluVac->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="date"
                                                value="{{ (!empty($fluVac)) ? $fluVac->using_date: null }}"
                                                class="form-control" name="flu_date">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <form id="job-reference-form" method="post"
                                action="{{route('worker-references',['id'=>$model->id])}}" data-parsley-validate
                                class="form-horizontal form-label-left" enctype="multipart/form-data">

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align">Number of refrences
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="worker_number_of_references" class="form-control"
                                            onchange="references(this)">
                                            <option value="">Select</option>
                                            @for($i=1;$i<10;$i++) <option value="{{$i}}" {{( $references->count() == $i)
                                                ? 'selected': ''}}>{{$i}}</option>
                                                @endfor
                                        </select>
                                    </div>
                                ...
                                <div class="job-references" id="job-references">
                                    ...
                                    <div class="reference-details">
                                        ...
                                        <div class="item form-group d-flex justify-content-center">
                                            <label class="col-form-label col-md-7 col-sm-7 label-align">Details of
                                                {{($k+1).$suffix}} Reference</label>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" name="old_name[]" value="{{$ref->name}}"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input type="email" name="old_email[]" value="{{$ref->email}}"
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" name="old_phone[]" value="{{$ref->phone}}"
                                                    class="form-control" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"> Date
                                                Refered</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input type="date" name="old_date_referred[]"
                                                    value="{{$ref->date_referred}}" class="form-control"
                                                    placeholder="" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3 label-align"> Min Title Of
                                                Reference</label>
                                            <div class="col-md-6 col-sm-6">
                                                <input type="text" name="old_min_title_of_reference[]"
                                                    value="{{$ref->min_title_of_reference}}" class="form-control"
                                                    placeholder="" />
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <select name="old_recency_of_reference[]" class="form-control">
                                                    <option value="1" {{( $ref->recency_of_reference == '1') ?
                                                        'selected': ''}}>Yes</option>
                                                    <option value="0" {{( $ref->recency_of_reference == '0') ?
                                                        'selected': ''}}>No</option>
                                                </select>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                <a href="{{URL::asset('images/nurses/reference/'.$ref->image)}}"
                                                    target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                    data-placement="bottom" title="View"><i
                                                        class="fa fa-download"></i>{{$file_name}} </a>
                                            </div>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <form id="certification-form" method="post"
                                action="{{route('worker-certification',['id'=>$model->id])}}" data-parsley-validate
                                class="form-horizontal form-label-left" enctype="multipart/form-data">

                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> BLS certificate?
                                    </label>
                                    <div class="col-md-6 col-sm-6">

                                        <select name="bls_cer" class="form-control" data-type="bls-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                ...
                                <div class="bls-container {{ (empty($blsCer)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/vaccination/'.$blsCer->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> ACLS certificate ?
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="acls_cer" class="form-control" data-type="acls-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                ...
                                <div class="acls-container {{ (empty($aclsCer)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/vaccination/'.$aclsCer->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> PALS certificate ?
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <select name="pals_cer" class="form-control" data-type="pals-container"
                                            onchange="hide_show_select(this)">
                                            <option value="">Select</option>
                                ...
                                <div class="pals-container {{ (empty($palsCer)) ? 'd-none': ''}}">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/vaccination/'.$palsCer->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Other Certificate
                                    </label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control"
                                            value="{{$model->other_certificate_name}}" name="other_certificate_name"
                                ...
                                <div class="other-container">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <a href="{{URL::asset('images/nurses/vaccination/'.$otherCer->name)}}"
                                                target="_blank" class="btn brn-success" data-toggle="tooltip"
                                                data-placement="bottom" title="View"><i
                                                    class="fa fa-download"></i>{{$file_name}} </a>
                                        </div>
