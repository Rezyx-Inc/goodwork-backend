...
<div class="ss-admin-wr-prfil-mn-dv">
  ...
  <li class="nav-item">
    <a class="nav-link" id="profile-tab-ex" data-toggle="tab" href="#profile-ex" role="tab" aria-controls="profile-ex"
      aria-selected="false">Professional Information</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" id="refrence-tab-ex" data-toggle="tab" href="#refrence-ex" role="tab" aria-controls="contact-ex"
      aria-selected="false">References</a>
  </li>

  <li class="nav-item">
    <a class="nav-link" id="cert-tab-ex" data-toggle="tab" href="#cert-ex" role="tab" aria-controls="contact-ex"
      ...
      <div class="row">
        ...
        <!--         <label>Specialty and Experience</label>
              ...
              <div class="ss-form-group">
               ...
               <input id="number" type="number" placeholder="What is your license number?">
               </div>
         ...
         <div class="ss-pers-info-form-mn-dv ss-wrkr-per-infosub-ope">
           <form>
            ...
            <div class="ss-form-group">
              ...
              <input type="text" name="text" placeholder="Where did you work recently">
            </div>
            ...
            <div class="ss-form-group">
              ...
              <input type="text" name="text" placeholder="Yes we need your SS# to submit you">
            </div>
          ...
          <div class="ss-pers-info-form-mn-dv ss-wrkr-per-urgncy-ope">
            <form>
             <div class="ss-persnl-frm-hed">
              ...
              <div class="ss-form-group">
              <label>Urgency</label>
              <input type="text" name="text" placeholder="How quickly can you be ready to submit?">
            </div>

             <div class="ss-form-group">
              <label># of Positions Available</label>
              <input type="text" name="text" placeholder="You have applied to # jobs?">
            </div>
            ...
            <div class="ss-form-group">
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                  ...
                  <input type="text" name="text" placeholder="Where does the IRS think you live?">
                </div>
              </div>

              <div class="ss-form-group">
              <label>Facility</label>
              <input type="text" name="text" placeholder="What facilities have you worked at?">
            </div>

             <div class="ss-form-group">
              <label>Facility's Parent System</label>
              <input type="text" name="text" placeholder="What facilities would you like to work at?">
            </div>


               <div class="ss-form-group">
              <label>Facility Average Rating</label>
              <input type="text" name="text" placeholder="Your average rating by your facilities">
            </div>

             <div class="ss-form-group">
              <label>Recruiter Average Rating</label>
              <input type="text" name="text" placeholder="Your average rating by your recruiters">
            </div>

             <div class="ss-form-group">
              <label>Facility Average Rating</label>
              <input type="text" name="text" placeholder="Your average rating by your employers">
            </div>
           ...
           <div class="ss-pers-info-form-mn-dv ss-wrkr-per-pnt-rtio-ope">
            ...
            <div class="ss-form-live-location">
                <div class="ss-form-group">
                  ...
                  <input type="text" name="text" placeholder="How many patients can you handle?">
                </div>
              </div>
            ...
            <div class="ss-form-group">
             ...
             <div class="ss-form-group">
              ...
              <input type="text" name="text" placeholder="king or california king ?">
            </div>
           ...
           <!-----------------Interview Dates-------------->
            ...
            <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><input type="date" id="birthday" name="birthday"></a>
                </div>
              </div>
               ...
               <div class="ss-form-live-location">
                <div class="ss-form-group ss-date-check-div">
                 ...
                 <li> <label>Start Date</label></li>
                  ...
                  <label for="vehicle1"> As soon As Posible</label></li>
                </ul>
                 <input type="date" id="birthday" name="birthday">
                </div>
              </div>
            ...
            <div class="ss-form-group">
             ...
             <div class="ss-form-live-location">
                <div class="ss-form-group">
                  ...
                  <input type="text" name="text" placeholder="Ideal Hours per week?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                  ...
                  <input type="text" name="text" placeholder="Open to jobs with no guaranteed hours?">
                </div>
              </div>
            ...
            <div class="ss-form-group">
             ...
             <div class="ss-form-group">
              ...
              <input type="text" name="text" placeholder="# of people you have referred">
            </div>
            ...
            <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="What kind of bonus do you expect?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="What kind of bonus do you deserve?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="What are you comparing this too?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="Other bonuses you want?">
                </div>
              </div>
            ...
            <div class="ss-form-group">
             ...
             <div class="ss-form-live-location">
                <div class="ss-form-group">
                  ...
                  <input type="text" name="text" placeholder="What range is fair?">
                </div>
              </div>
            ...
            <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <select name="cars" id="cars">
                  <option value="volvo">Would you work more for a higher rate?</option>
                   <option value="saab">yes</option>
                   <option value="saab">No</option>
                </select>
                </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="Is this rate reasonable?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="Are you going to duplicate expenses?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="What range is reasonable?">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="you only have (count down time) left before your rate drops from 5% to 2%">
                </div>
              </div>
              ...
              <div class="ss-form-live-location">
                <div class="ss-form-group">
                 ...
                 <input type="text" name="text" placeholder="How would you spend those extra funds?">
                </div>
              </div>
           ...
           <form>
             <div class="ss-persnl-frm-hed">
               <p><img src="{{URL::asset('backend/assets/images/my-per-con-user.png')}}"> Vaccinations &amp; Immunizations</p>
                ...
                <ul>
                  <li>
                    <input type="text" name="Enter Vacc. or Immu. name" placeholder="Enter Vacc. or Immu. name">
                  </li>
                  <li><div class="ss-prsn-frm-plu-div"><a href=""><i class="fa fa-plus" aria-hidden="true"></i></a></div></li>
                </ul>
              </div>
                </div>
           ...
           <form>
             <div class="ss-persnl-frm-hed">
               <p><img src="{{URL::asset('backend/assets/images/my-per--con-refren.png')}}"> References</p>
                ...
                <div class="ss-form-group">
                  <label>Phone </label>
                  <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" placeholder="Enter Referred Phone">
                </div>

                <div class="ss-form-group">
                  <label>Email </label>
                 <input type="email" id="email" name="email" placeholder="Enter Referred Email">
                </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-7">
          ...
          <div class="ss-counter-immu-plus-div">
                <ul>
                  <li>
                    <input type="text" name="Enter Vacc. or Immu. name" placeholder="Enter Certification Name">
                  </li>
                  <li><div class="ss-prsn-frm-plu-div"><a href=""><i class="fa fa-plus" aria-hidden="true"></i></a></div></li>
                </ul>
              </div>
