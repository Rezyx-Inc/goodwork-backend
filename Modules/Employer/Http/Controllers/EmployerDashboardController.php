...
class EmployerDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $alljobs = Job::where('employer_id', $id)->get();
        $statusCounts = [];
        $offerLists = [];
        ...
        return view('employer::dashboard', compact('statusCounts'));
    }
    ...
    public function profile()
    {
        ...
        // }
        return view('employer::employer/profile', compact('user', 'helpsupportdata', 'helpsupportcomments'));
    }

    public function communication()
    {
        // $user = User::select('first_name', 'last_name', 'image')->find($id);
        // return view('employer::employer/communication', compact('user'));

        return view('employer::employer/communication');
    }
    ...
    public function updateProfile(Request $request){
        ...
        $id = Auth::guard('employer')->user()->id;
        $oldqualities = Auth::guard('employer')->user()->qualities;
    ...
    public function employerRemoveQualities(Request $request){
    ...
    public function askemployerNotification(Request $request){
        $validator = Validator::make($request->all(), [
            'worker_id' => 'required',
            'update_key' => 'required',
        ]);
