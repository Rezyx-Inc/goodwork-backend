                ...
                <div class="ss-jb-apl-oninfrm-mn-dv">
                    ...
                    $data2 .= '
                        ...
                        <div class="col-md-12">
                            ...
                            <button class="ss-counter-button w-100" onclick="offerSend(\'' . $request->id . '\', \''. $jobdetails['id'] .'\', \'offersend\', \'' . $workerdetails->user_id .'\', \'' . $jobdetails['employer_id'] .'\')">Send Offer</button>
                        </div>
                    </ul>
                </div>
                ';
