...
class OpportunitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employer::employer/opportunitiesmanager',compact('darftJobs','specialities','professions','publishedJobs','onholdJobs','states'));
