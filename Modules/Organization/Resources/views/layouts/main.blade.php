...
<head>
    ...
    <link rel='stylesheet' href='{{URL::asset("organization/custom/css/owl.carousel.css")}}'>
    <link rel='stylesheet' href='{{URL::asset("organization/custom/css/mdb.min.css")}}'>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0" />
    <link rel="stylesheet" href="{{URL::asset('organization/custom/css/style.css')}}" />
    <link rel="stylesheet" href="{{URL::asset('organization/custom/css/custom.css')}}" />
...
<body>
    ...
    <header>
        ...
        @include('organization::partials.header')
    </header>
    @yield('content')
