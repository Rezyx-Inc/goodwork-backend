                ...
                <div class="col-lg-7">
                    <div class="ss-msg-rply-mn-div">
                        <div class="ss-msg-rply-profile-sec">
                            <ul>
                                <li>
                                    <img width="50px" height="50px" id="userprofile" src="{{ asset('frontend/img/profile-pic-big.png') }}" onerror="this.onerror=null; this.src = '{{USER_IMG_ORGANIZATION}}';" id="preview" width="50px" height="50px" style="object-fit: cover;" />
                                </li>
                                <li>
                                    <h6 id="username"></h6>
                                    <p id="profession"></p>
...
<script>
    ...
    function saveMessage(message) {
        ...
        var senderid = '<?php echo auth()->guard('organization')->user()->id ?>';
        ...
        //     Nu_name: nursename,
        //     Sm_id: senderid,
        //     Sm_image: '<?php echo auth()->guard('organization')->user()->image ?>',
        //     Sm_mobile: '<?php echo auth()->guard('organization')->user()->mobile ?>',
        //     Sm_name: '<?php echo auth()->guard('organization')->user()->first_name ?>' + " " + '<?php echo auth()->guard('organization')->user()->last_name ?>',
        //     Worker_userid: "",
        //     isOnline: "Onlineww",
        //     isRecOnline: "Online",
        //     message: message,
    ...
    function fetchMessages() {
        ...
        messagesRef.on('value', function(snapshot) {
            ...
            snapshot.forEach(function(childSnapshot) {
                ...
                let msgtype = "";
                if (messageData.senderfind == "ORGANIZATION") {
                    msgtype = "blue-dv"
                } else {
                    msgtype = "recrut-dv"
                }
    ...
    function fetchSingleUserChat() {
        ...
        if (csrfToken) {
            var url = `{{ url('organization/get-single-nurse-details') }}/${nurse_id}`;
