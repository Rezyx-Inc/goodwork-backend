...
@section('content')
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="ss-prsn-frm-plu-div"><a href="javascript:void(0)"
                                                                onclick="add_speciality(this)"><i class="fa fa-plus"
    ...
    @endif
                                ...
                                <div class="ss-form-group ss-prsnl-frm-specialty">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="ss-prsn-frm-plu-div"><a href="javascript:void(0)"
                                                    onclick="addvacc(this)"><i class="fa fa-plus"
                                                        aria-hidden="true"></i></a></div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <input type="number" name="number_of_references"
                                        placeholder="Enter Number of Reference" id="number_of_references" maxlength="9">
                                </div>
                                <div class="ss-form-group col-md-4">
                                ...
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <input type="number" name="recency_of_reference"
    ...
    @endif
                                ...
                                <div class="ss-form-group ss-prsnl-frm-specialty">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="ss-prsn-frm-plu-div"><a href="javascript:void(0)"
                                                    onclick="addcertifications(this)"><i class="fa fa-plus"
                                                        aria-hidden="true"></i></a></div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <input type="number" name="position_available"
    ...
    @endif -->
                                ...
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <select name="contract_termination_policy" class="contract_termination_policy mb-3"
    ...
    @endif -->
                                ...
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <input type="text" name="organization_weekly_amount" placeholder="---" disabled>
                                </div>
                                <div class="ss-form-group col-md-4">
                                ...
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <input type="number" name="total_organization_amount" placeholder="---" disabled>
                                </div>
                                <div class="ss-form-group col-md-4">
                                ...
                                <div class="ss-form-group col-md-4">
                                    ...
                                    <input type="text" name="goodwork_number" id="goodwork_number"
                                        placeholder="Unique Key" disabled>
                                </div>
                            </div>
            ...
            $('#create-new-job').on('submit', function(event) {
                ...
                if (csrfToken) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        // url: '{{ url('organization/organization-create-opportunity/create') }}',
                        url: "{{ route('organization-create-opportunity-store', ['check_type' => 'create']) }}",
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            inputFields.forEach(function(input) {
                input.addEventListener('blur', function() {
                    if (document.getElementById('job_name').value.trim() !== '' && document
                        .getElementById('type').value.trim() !== '') {
                        var csrfToken = $('meta[name="csrf-token"]').attr('content');
                        if (csrfToken) {
                            event.preventDefault();
                            var formData = "";
                            ...
                            if (document.getElementById('job_id').value.trim() !== '') {
                                ...
                                if (formName == "vaccinations" || formName ==
                                    "preferred_specialty" || formName == "preferred_experience" ||
                                    formName == "certificate") {
                                    var inputFields = document.querySelectorAll(formName ==
                                        "vaccinations" ? 'select[name="vaccinations"]' :
                                        formName == "preferred_specialty" ?
                                        'select[name="preferred_specialty"]' : formName ==
                                        "preferred_experience" ?
                                        'input[name="preferred_experience"]' :
                                ...
                                formData += '&job_id=' + encodeURIComponent(document.getElementById(
                                    'job_id').value.trim());
                                check_type = "update";
                            } else {
                                formData = {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                // url: "{{ route('organization-create-opportunity-store', ['check_type' => '" + urlencode(check_type) + "']) }}",
                                url: "{{ url('organization/organization-create-opportunity') }}/" +
                                    check_type,
                                ...
                                success: function(data) {
                                    ...
                                    if (document.getElementById('job_id').value
                                        .trim() == '' || document.getElementById(
                                            'job_id')
                                        .value.trim() == 'null' || document
                                        .getElementById('job_id').value.trim() == null
                                    ) {
                                        document.getElementById("job_id").value = data
                                            .job_id;
                                        document.getElementById("goodwork_number")
                                            .value = data.goodwork_number;
                                    }
                                },
                                error: function(error) {
                                    console.log(error);
        ...
        function list_specialities() {
            ...
            for (const key in speciality) {
                ...
                if (speciality.hasOwnProperty(key)) {
                    ...
                    str += '<li class="w-50 text-end pe-3"><button type="button"  id="remove-speciality" data-key="' + key +
