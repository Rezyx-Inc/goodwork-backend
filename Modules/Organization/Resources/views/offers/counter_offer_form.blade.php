<div>
    <h4><img src="{{ URL::asset('public/organization/assets/images/counter-left-img.png') }}"> Send Offer</h4>
...
<form class="ss-emplor-form-sec" id="send-job-offer">
        ...
        <select name="type" id="type">
            ...
            @if (isset($allKeywords['Type']))
                @foreach ($allKeywords['Type'] as $value)
                    <option value="{{ $value->title }}" {{ $offerdetails['type'] == $value->id ? 'selected' : '' }}>
                        {{ $value->title }}</option>
                @endforeach
            @endif
        </select>
            ...
            @if (isset($allKeywords['Terms']))
                @foreach ($allKeywords['Terms'] as $value)
                    <option value="{{ $value->id }}"
                        {{ $offerdetails['terms'] == $value->id ? 'selected' : '' }}>{{ $value->title }}</option>
                @endforeach
            @endif
        </select>
    </div>
        ...
        <select name="profession" id="profession">
            ...
            @if (isset($allKeywords['Profession']))
                @foreach ($allKeywords['Profession'] as $value)
                    <option value="{{ $value->id }}"
                        {{ $offerdetails['profession'] == $value->id ? 'selected' : '' }}> {{ $value->title }}
                    </option>
                @endforeach
            @endif
        </select>
    ...
    <div class="ss-form-group ss-prsnl-frm-specialty">
        ...
        <div class="col-md-12">
            <select name="preferred_specialty" class="m-0" id="preferred_specialty">
                <option value="{{ $offerdetails['preferred_specialty'] }}">{{ $offerdetails['preferred_specialty'] }}
                </option>
    ...
    <div class="ss-form-group row justify-contenet-center align-items-center" style="margin-top:36px;">
        ...
        <input style="box-shadow:none; width: auto;" class="col-lg-6 col-sm-2 col-xs-2 col-md-2" type="radio"
            id="option1" name="option" value="1" autocompleted="" disabled>
    </div>
    <div class="ss-form-group">
        <label>Float requirements</label>
        <select name="float_requirement" class="float_requirement mb-3" id="float_requirement"
            value="{{ $offerdetails['float_requirement'] }}">
    ...
    <div class="ss-form-group">
        ...
        <select name="facility_shift_cancelation_policy" class="facility_shift_cancelation_policy mb-3"
            id="facility_shift_cancelation_policy" value="{{ $offerdetails['facility_shift_cancelation_policy'] }}">
            <option value="{{ $offerdetails['facility_shift_cancelation_policy'] }}">
                {{ $offerdetails['facility_shift_cancelation_policy'] }}</option>
            @if (isset($allKeywords['AssignmentDuration']))
                @foreach ($allKeywords['AssignmentDuration'] as $value)
                    <option value="{{ $value->id }}"
                        {{ $offerdetails['block_scheduling'] == $value->id ? 'selected' : '' }}>{{ $value->title }}
                    </option>
                @endforeach
            @endif
        </select>
    ...
    <div class="ss-form-group">
        ...
        <input type="text" id="contract_termination_policy" name="contract_termination_policy"
            ...
            value="{{ isset($offerdetails['contract_termination_policy']) ? $offerdetails['contract_termination_policy'] : '2 weeks of guaranteed pay unless canceled for cause' }}">
    </div>
    <span class="help-block-contract_termination_policy"></span>
    <div class="ss-form-group">
        <label>Traveler Distance From Facility</label>
        <input type="number" id="traveler_distance_from_facility" name="traveler_distance_from_facility"
            placeholder="Enter Traveler Distance From Facility"
            value="{{ $offerdetails['traveler_distance_from_facility'] }}">
    </div>
        ...
        <select name="facility" class="facility mb-3" id="facility">
            ...
            @if (isset($allKeywords['FacilityName']))
                @foreach ($allKeywords['FacilityName'] as $value)
                    <option value="{{ $value->id }}"
                        {{ $offerdetails['facility'] == $value->id ? 'selected' : '' }}>{{ $value->title }}</option>
                @endforeach
            @endif
        </select>
    </div>
    ...
    <div class="ss-form-group">
        ...
        <input type="text" id="clinical_setting" name="clinical_setting" placeholder="Enter clinical setting"
            value="{{ $offerdetails['clinical_setting'] }}">
    </div>
    <span class="help-block-clinical_setting"></span>
    <div class="ss-form-group">
        <label>Patient ratio</label>
        <input type="number" id="Patient_ratio" name="Patient_ratio"
            placeholder="How many patients can you handle?" value="{{ $offerdetails['Patient_ratio'] }}">
    </div>
        ...
        <select name="emr" class="emr mb-3" id="emr">
            ...
            @if (isset($allKeywords['EMR']))
                @foreach ($allKeywords['EMR'] as $value)
                    <option value="{{ $value->id }}" {{ $offerdetails['Emr'] == $value->id ? 'selected' : '' }}>
                        {{ $value->title }}</option>
                @endforeach
            @endif
        </select>
    ...
    <div class="ss-form-group">
        <label>Unit</label>
        <input id="Unit" type="text" name="Unit" placeholder="Enter Unit"
            value="{{ $offerdetails['Unit'] }}">
    </div>
    <span class="help-block-Unit"></span>
    <div class="ss-form-group">
        <label>Scrub Color</label>
        <input id="scrub_color" type="text" name="scrub_color" placeholder="Enter Scrub Color"
            value="{{ $offerdetails['scrub_color'] }}">
    </div>
        ...
        <select name="preferred_shift" id="preferred_shift">
            ...
            @if (isset($allKeywords['PreferredShift']))
                @foreach ($allKeywords['PreferredShift'] as $value)
                    <option value="{{ $value->id }}"
                        {{ $offerdetails['preferred_shift'] == $value->id ? 'selected' : '' }}>{{ $value->title }}
                    </option>
                @endforeach
            @endif
    ...
    <div class="ss-form-group">
        ...
        <input id="hours_per_week" type="number" name="hours_per_week" placeholder="Enter Hours/Week"
            value="{{ $offerdetails['hours_per_week'] }}">
    </div>
    <span class="help-block-hours_per_week"></span>
    <div class="ss-form-group">
        <label>Guaranteed Hours</label>
        <input id="guaranteed_hours" type="number" name="guaranteed_hours" placeholder="Enter Guaranteed Hours"
            value="{{ $offerdetails['guaranteed_hours'] }}">
    </div>
    <span class="help-block-guaranteed_hours"></span>
    <div class="ss-form-group">
        <label>Hours/Shift</label>
        <input id="hours_shift" type="number" name="hours_shift" placeholder="Enter Hours/Shift"
            value="{{ $offerdetails['hours_shift'] }}">
    </div>
    <span class="help-block-hours_shift"></span>
    <div class="ss-form-group">
        <label>Weeks/Assignment</label>
        <input id="preferred_assignment_duration" type="number" name="preferred_assignment_duration"
            placeholder="Enter Weeks/Assignment" value="{{ $offerdetails['preferred_assignment_duration'] }}">
    </div>
    <span class="help-block-preferred_assignment_duration"></span>
    <div class="ss-form-group">
        <label>Shifts/Week</label>
        <input id="weeks_shift" type="number" name="weeks_shift" placeholder="Enter Shifts/Week"
            value="{{ $offerdetails['weeks_shift'] }}">
    </div>
    <span class="help-block-weeks_shift"></span>
    <div class="ss-form-group">
        <label>Sign-On Bonus</label>
        <input id="sign_on_bonus" type="number" name="sign_on_bonus" placeholder="Enter Sign-On Bonus"
            value="{{ $offerdetails['sign_on_bonus'] }}">
    </div>
    <span class="help-block-sign_on_bonus"></span>
    <div class="ss-form-group">
        <label>Completion Bonus</label>
        <input id="completion_bonus" type="number" name="completion_bonus" placeholder="Enter Completion Bonus"
            value="{{ $offerdetails['completion_bonus'] }}">
    </div>
    <span class="help-block-completion_bonus"></span>
    <div class="ss-form-group">
        <label>Extension Bonus</label>
        <input id="extension_bonus" type="number" name="extension_bonus" placeholder="Enter Extension Bonus"
            value="{{ $offerdetails['extension_bonus'] }}">
    </div>
    <span class="help-block-extension_bonus"></span>
    <div class="ss-form-group">
        <label>Other Bonus</label>
        <input id="other_bonus" type="number" name="other_bonus" placeholder="Enter Other Bonus"
            value="{{ $offerdetails['other_bonus'] }}">
    </div>
    <span class="help-block-other_bonus"></span>
    <div class="ss-form-group">
        <label>Referral Bonus</label>
        <input id="referral_bonus" type="number" name="referral_bonus" placeholder="Enter Referral Bonus"
            value="{{ $offerdetails['referral_bonus'] }}">
    </div>
    ...
    <div class="ss-form-group">
        ...
        <select name="health_insaurance" id="health_insaurance">
            ...
            <option value="{{ $offerdetails['health_insaurance'] }}">
                {{ $offerdetails['health_insaurance'] == '1' ? 'Yes' : 'No' }}</option>
    ...
    <div class="ss-form-group">
        ...
        <select name="dental" id="dental">
            <option value="{{ $offerdetails['dental'] }}">{{ $offerdetails['dental'] == '1' ? 'Yes' : 'No' }}
            </option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
        </select>
    ...
    <div class="ss-form-group">
        ...
        <select name="vision" id="vision">
            <option value="{{ $offerdetails['vision'] }}">{{ $offerdetails['vision'] == '1' ? 'Yes' : 'No' }}
            </option>
            <option value="Yes">Yes</option>
            <option value="No">No</option>
        </select>
    ...
    <div class="ss-form-group">
        ...
        <input id="actual_hourly_rate" type="number" name="actual_hourly_rate"
            placeholder="Enter Actual Hourly rate" value="{{ $offerdetails['actual_hourly_rate'] }}">
    </div>
    ...
    <div class="ss-form-group">
        ...
        <input id="orientation_rate" type="number" name="orientation_rate" placeholder="Enter Orientation Rate"
            value="{{ $offerdetails['orientation_rate'] }}">
    </div>
    <span class="help-block-orientation_rate"></span>
    <div class="ss-form-group">
        <label>Est. Weekly Taxable amount</label>
        <input type="number" name="weekly_taxable_amount" id="weekly_taxable_amount" placeholder="---"
            value="{{ $offerdetails['weekly_taxable_amount'] }}" readonly>
    </div>
    <div class="ss-form-group">
        <label>Est. Weekly non-taxable amount</label>
        <input type="number" name="weekly_non_taxable_amount" id="weekly_non_taxable_amount" placeholder="---"
            value="{{ $offerdetails['weekly_non_taxable_amount'] }}" readonly>
    </div>
    <div class="ss-form-group">
        <label>Est. Organization Weekly Amount</label>
        <input type="number" name="organization_weekly_amount" id="organization_weekly_amount" placeholder="---"
            value="{{ $offerdetails['organization_weekly_amount'] }}" readonly>
    </div>
    <div class="ss-form-group">
        <label>Est. Goodwork Weekly Amount</label>
        <input type="number" name="goodwork_weekly_amount" id="goodwork_weekly_amount" placeholder="---"
            value="{{ $offerdetails['weekly_taxable_amount'] }}" readonly>
    </div>
    <div class="ss-form-group">
        <label>Est. Total Organization Amount</label>
        <input type="number" name="total_organization_amount" id="total_organization_amount" placeholder="---"
            value="{{ $offerdetails['total_organization_amount'] }}" readonly>
    </div>
    <div class="ss-form-group">
        <label>Est. Total Goodwork Amount</label>
        <input type="number" name="total_goodwork_amount" id="total_goodwork_amount" placeholder="---"
            value="{{ $offerdetails['total_goodwork_amount'] }}" readonly>
    </div>
    <div class="ss-form-group">
        <label>Est. Total Contract Amount</label>
        <input type="text" name="total_contract_amount" id="total_contract_amount" placeholder="---"
            value="{{ $offerdetails['total_contract_amount'] }}" readonly>
    </div>
        ...
        try {
            ...
            if (csrfToken) {
                $.ajax({
                    ...
                    url: "{{ url('organization/organization-counter-offer') }}",
                    data: {
                        'token': csrfToken,
                        'data': data,
                        'id': id
