...
class OrganizationApplicationController extends Controller
{
    ...
    public function application()
    {
        ...
        $statusList = ['Apply', 'Screening', 'Submitted', 'Offered', 'Done', 'Onboarding', 'Cleared_to_Start', 'Working', 'Rejected', 'Blocked', 'Hold'];
        $statusCounts = [];
        $offerLists = [];
    ...
    public function updateApplicationStatus(Request $request)
    {
        ...
        if (isset($jobid)) {
            ...
            if ($job) {
                ...
                $statusList = ['Apply', 'Screening', 'Submitted', 'Offered', 'Done', 'Onboarding', 'Cleared to Start', 'Working', 'Rejected', 'Blocked', 'Hold'];
                $statusCounts = [];
                $offerLists = [];
                foreach ($statusList as $status) {
                    $statusCounts[$status] = 0;
