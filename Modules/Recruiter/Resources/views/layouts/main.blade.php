...
<head>
    ...
    <link rel='stylesheet' href='{{URL::asset("public/recruiter/custom/css/owl.carousel.css")}}'>
    <link rel='stylesheet' href='{{URL::asset("public/recruiter/custom/css/mdb.min.css")}}'>

    <link rel="stylesheet" href="{{URL::asset('public/frontend/css/style.css')}}" />
    <link rel="stylesheet" href="{{URL::asset('public/recruiter/custom/css/custom.css')}}" />
...
<body>
    ...
    <script type="text/javascript" src="{{URL::asset('public/recruiter/custom/js/owl.carousel.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('public/recruiter/custom/js/mdb.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset('public/recruiter/custom/js/nav-bar-script.js')}}"></script>
