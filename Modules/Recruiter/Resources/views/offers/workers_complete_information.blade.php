    ...
    <ul class="row">
        <li class="col-md-6">
            ...
            <h6>
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'highest_nursing_degree', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'specialty', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'distance_from_your_home', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'worked_at_facility_before', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                @isset($nursedetails['state'])
                    {{ $nursedetails['state'] }}
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'state', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'worker_shift_time_of_day', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
        ...
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'facilities_you_like_to_work_at', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'worker_start_date', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                @isset($offerdetails['rto'])
                    {{ $offerdetails['rto'] }}
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'rto', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]['job_id'] }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
        ...
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                ...
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'worker_weeks_assignment', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
        <li class="col-md-6">
            ...
            <h6 class="mb-3">
                @isset($nursedetails['worker_employer_weekly_amount'])
                    {{ $nursedetails['worker_employer_weekly_amount'] }}
                @else
                    <a style="cursor: pointer;" onclick="askWorker(this, 'worker_employer_weekly_amount', '{{ $nursedetails['id'] }}', '{{ $offerdetails[0]->job_id }}')">Ask Worker</a>
                @endisset
            </h6>
        </li>
