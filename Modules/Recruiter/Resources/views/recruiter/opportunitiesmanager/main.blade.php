...
@section('content')
                ...
                <div class="ss-acount-profile d-none" id="published-job-details">
                    <div class="row">
                        ...
                        <!-- END ONHOLD CARDS -->
                         ...
                         {{-- drafts form --}}
                            @include('recruiter::recruiter.opportunitiesmanager.drafts')
                         {{-- end drafts from --}}

                        {{-- edit published jobs form --}}
                            @include('recruiter::recruiter.opportunitiesmanager.edit_job')
    ...
    @include('recruiter::recruiter.opportunitiesmanager.scripts.opportunitiesManagerStyles');
@include('recruiter::recruiter.opportunitiesmanager.scripts.opportunitiesManagerScripts');
@endsection
