            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="ss-login-work-logo-div">
                        ...
                        <div class="ss-login-logo-dv">
                            <img src="{{ URL::asset('landing/img/logo_signup_recruiter.png') }}" />
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="ss-login-work-dv">
                        ...
                        <form class="" method="post" action="{{ route('recruiter.signup') }}"
                            ...
                            <div class="ss-form-group">
                                <input type="tel" id="contact_number" name="mobile" placeholder="Mobile"
                                    onchange=contactNumber(this)><br />
