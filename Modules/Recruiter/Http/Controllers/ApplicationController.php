                    ...
                    <div class="ss-jb-apl-oninfrm-mn-dv">
                        ...
                        $data2 .= '
                            ...
                            <div class="col-md-6 ' . ($jobdetails->recruiter_average_rating ? '' : 'd-none' ) . '">
                                <p>' . ($workerdetails->worker_avg_rating_by_recruiters ?? '<u onclick="askWorker(this, \'worker_avg_rating_by_recruiters\', \''. $workerdetails['id'] . '\', \''. $jobdetails['id'] . '\')">Ask Worker</u>' ) . '</p>
                            </div>
                            <div class="col-md-12">
...
>>>>>>> 82fff7c95dbf688b56d844133e29739f020b432d
                ...
                $data2 .= '
                    <ul class="ss-cng-appli-hedpfl-ul">
                        ...
                        <li>
                            <a href="' . route('recruiter-messages') . '" class="rounded-pill ss-apply-btn py-2 border-0 px-4" onclick="chatNow(\'' . $offerdetails['worker_id'] . '\')">Chat Now</a>
                        </li>
                    </ul>
