...
Route::prefix('recruiter')->group(function () {
    ...
    Route::middleware(['recruiter_not_logged_in'])->group(function () {
        ...
        Route::get('/verify', ['uses' => 'RecruiterAuthController@verify', 'as' => 'recruiter.verify']);
    ...
    Route::middleware(['recruiter_logged_in'])->group(function () {
        /** Dashboard routes */
        Route::get('/dashboard', ['uses' => 'RecruiterDashboardController@index', 'as' => 'recruiter-dashboard']);
        Route::get('/messages', ['uses' => 'RecruiterDashboardController@communication', 'as' => 'recruiter-messages']);
        Route::get('/profile', ['uses' => 'RecruiterDashboardController@profile', 'as' => 'recruiter-profile']);
        ...
        Route::get('/application',  ['uses' => 'ApplicationController@application', 'as' => 'recruiter-application']);
        ...
        Route::get('/opportunities-manager', ['uses' => 'OpportunitiesController@index', 'as' => 'recruiter-opportunities-manager']);
