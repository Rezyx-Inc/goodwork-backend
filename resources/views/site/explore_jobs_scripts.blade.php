                                ...
                                <div class="ss-jb-apl-oninfrm-mn-dv">
                                    ...
                                    <div id="shift" class="collapse">
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul type_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                               <h6>
                                                    ${job.guaranteed_hours ? (Number(job.guaranteed_hours) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul type_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.weeks_shift ? (Number(job.weeks_shift) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                    ...
                                    <div id="pay" class="collapse">
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul overtime_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.overtime ? (Number(job.overtime) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul on_call_rate_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.on_call_rate ? `$${(Number(job.on_call_rate) || 0).toFixed(0)}`  : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul call_back_rate_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.call_back_rate ? `$${(Number(job.call_back_rate) || 0).toFixed(0)}` : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul orientation_rate_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.orientation_rate ? (Number(job.orientation_rate) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul weekly_non_taxable_amount_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.weekly_non_taxable_amount ? `$${(Number(job.weekly_non_taxable_amount) || 0).toFixed(0)}` : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul feels_like_per_hour_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.feels_like_per_hour ?  `$${(Number(job.feels_like_per_hour) || 0).toFixed(0)}` : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.goodwork_weekly_amount ? `$${(Number(job.goodwork_weekly_amount) || 0).toFixed(0)}` : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul referral_bonus_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.referral_bonus ? (Number(job.referral_bonus) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul sign_on_bonus_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.sign_on_bonus ? `$${(Number(job.sign_on_bonus) || 0).toFixed(0)}` : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul extension_bonus_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.extension_bonus ? '$' + (Number(job.extension_bonus) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul completion_bonus_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.completion_bonus ? '$' + (Number(job.completion_bonus) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul other_bonus_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.other_bonus ? '$' + (Number(job.other_bonus) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
                                    ...
                                    <div id="workInfo" class="collapse">
                                        ...
                                        <ul class="ss-s-jb-apl-on-inf-txt-ul Patient_ratio_item ss-s-jb-apl-bg-pink">
                                            ...
                                            <li>
                                                <h6>
                                                    ${job.Patient_ratio ? (Number(job.Patient_ratio) || 0).toFixed(0) : askRecruiter}
                                                </h6>
                                            </li>
                                        </ul>
