                ...
                <div class="col-lg-6">
                    ...
                    <div class="ss-verification-mn-div">
                        ...
                        <form method="post" action="{{ route('otp.store') }}" id="otp-form" class="">
                            <ul class="ss-otp-v-ul">
                                <li><input type="text" name="otp1" oninput='digitValidate(this)'
                                        onkeyup='tabChange(1)' maxlength=1></li>
                                <li><input type="text" name="otp2" oninput='digitValidate(this)'
                                        onkeyup='tabChange(2)' maxlength=1></li>
                                <li><input type="text" name="otp3" oninput='digitValidate(this)'
                                        onkeyup='tabChange(3)' maxlength=1></li>
                                <li><input type="text" name="otp4" oninput='digitValidate(this)'onkeyup='tabChange(4)'
                                        maxlength=1></li>
                            </ul>
                            <button type="submit"><span id="loadingVerify" class="d-none">
                                    <span id="loadSpanVerify" class="spinner-border spinner-border-sm" role="status"
                        ...
                        <ul class="ss-otp-re-send">
                            <li><a href="javascript:void(0)" onclick="resend_otp()">Resend OTP in</a></li>
                            <li>
                                <p class="countdown">01:26</p>
                            </li>
                        </ul>
                    </div>
