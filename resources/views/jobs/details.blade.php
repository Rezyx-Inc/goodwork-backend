        ...
        <div class="container">
                        ...
                        <div class="ss-job-apply-on-view-detls-mn-dv">
                            ...
                            <div class="ss-jb-apl-oninfrm-mn-dv">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="What kind of professional are you?"
                                            data-filter="Profession" data-name="highest_nursing_degree"
                                            onclick="open_modal(this)">What kind of professional are you?</p>
                                    </li>
                                </ul>
                                ...
                                <ul
                                    ...
                                    <li>
                                        <p data-bs-toggle="modal" data-bs-target="#job-dtl-checklist">What's your specialty?
                                        </p>
                                    </li>
                                </ul>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-bs-toggle="modal" data-bs-target="#job-dtl-pop-cale">Where are you licensed?
                                        </p>
                                    </li>
                                </ul>
                                ...
                                <ul
                                    ...
                                    <li>
                                        ...
                                        <p data-bs-toggle="modal" data-bs-target="#job-dtl-References">Is this from your
                                            last assignment?</p>
                                    </li>
                                </ul>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p></p>
                                        @foreach ($certificates as $v)
                                            <p data-target="file" data-hidden_name="{{ strtolower($v) }}_cer"
                                                data-hidden_value="Yes" data-href="{{ route('certification') }}"
                                ...
                                <ul
                                    ...
                                    <li>
                                        <p data-target="binary" data-title="Does Congress allow you to work here?"
                                            data-name="eligible_work_in_us" onclick="open_modal(this)">Does Congress allow
                                            you to work here?</p>
                                    </li>
                                </ul>
                                ...
                                <ul
                                    ...
                                    <li>
                                        <p data-target="input" data-title="How quickly you can be ready to submit?"
                                            ...
                                            data-name="worker_urgency" onclick="open_modal(this)">How quickly you can be
                                            ready to submit?</p>
                                    </li>
                                </ul>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                        ...
                                        <h6>{{ $model->position_available - $model->getOfferCount() }} of
                                            {{ $model->position_available }}</h6>
                                    </li>
                                    <li>
                                ...
                                <ul
                                    class="ss-s-jb-apl-on-inf-txt-ul {{ $matches['msp']()['match'] ? 'ss-s-jb-apl-bg-blue' : 'ss-s-jb-apl-bg-pink' }}">
                                    <li>
                                        <span>MSP</span>
                                        <h6>{{ $model->msp }} </h6>
                                    </li>
                                    <li>
                                        <p data-target="dropdown" data-title="Any MSPs you prefer to avoid?"
                                            data-filter="MSP" data-name="MSP" onclick="open_modal(this)">Any MSPs you
                                            prefer to avoid?</p>
                                    </li>
                                </ul>
                                <ul
                                    class="ss-s-jb-apl-on-inf-txt-ul {{ $matches['vms']()['match'] ? 'ss-s-jb-apl-bg-blue' : 'ss-s-jb-apl-bg-pink' }}">
                                    <li>
                                        <span>VMS</span>
                                        <h6>{{ $model->vms }} </h6>
                                    </li>
                                    <li>
                                        <p data-target="dropdown" data-title="Who's is your favorite VMS?"
                                            data-filter="VMS" data-name="VMS" onclick="open_modal(this)">Who's is your
                                            favorite VMS?</p>
                                    </li>
                                </ul>
                                <ul
                                ...
                                <ul
                                    ...
                                    <li>
                                        <p data-target="binary" data-title="Are you willing float to?"
                                            data-name="float_requirement" onclick="open_modal(this)">Are you willing float
                                            to?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="What terms do you prefer?"
                                            data-filter="AssignmentDuration" data-name="facility_shift_cancelation_policy"
                                            onclick="open_modal(this)">What terms do you prefer?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="What terms do you prefer?"
                                            ...
                                            data-name="contract_termination_policy" onclick="open_modal(this)">What terms
                                            do you prefer?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Where does the IRS think you live?"
                                            data-placeholder="Where does the IRS think you live?"
                                            data-name="distance_from_your_home" onclick="open_modal(this)">Where does the
                                            IRS think you live?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="What Facilities would you like to work at?"
                                            data-placeholder="Write Name Of Facilities"
                                            data-name="worker_facility_parent_system" onclick="open_modal(this)">What
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Your average rating by your facilities?"
                                            data-placeholder="Your average rating by your facilities"
                                            data-name="avg_rating_by_facilities" onclick="open_modal(this)">Your average
                                            rating by your facilities?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Your average rating by your recruiters?"
                                            data-placeholder="Your average rating by your recruiters"
                                            data-name="worker_avg_rating_by_recruiters" onclick="open_modal(this)">Your
                                            average rating by your recruiters?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Your average rating by your organizations?"
                                            data-placeholder="Your average rating by your organizations"
                                            data-name="worker_avg_rating_by_organizations" onclick="open_modal(this)">Your
                                            average rating by your organizations?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="What setting do you prefer?"
                                            data-filter="SettingType" data-name="clinical_setting_you_prefer"
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="How many patients can you handle?"
                                            data-placeholder="How many patients can you handle?"
                                            data-name="worker_patient_ratio" onclick="open_modal(this)">How many patients
                                            can you handle?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="What EMRs have you used?" data-filter="EMR"
                                            data-name="worker_emr" onclick="open_modal(this)">What EMRs have you used?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Fav Department?"
                                            data-placeholder="Fav Department?" data-name="worker_department"
                                            onclick="open_modal(this)">Fav Department?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="King or California king?"
                                            data-placeholder="King or California king?" data-name="worker_bed_size"
                                            onclick="open_modal(this)">King or California king?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Ideal Trauma Level?"
                                            data-placeholder="Ideal Trauma Level?" data-name="worker_trauma_level"
                                            onclick="open_modal(this)">Ideal Trauma Level?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="Fav shift?" data-filter="shift_time_of_day"
                                            data-name="worker_shift_time_of_day" onclick="open_modal(this)">Fav shift?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Ideal hours per week?"
                                            data-placeholder="Enter number Of Hours/Week"
                                            data-name="worker_hours_per_week" onclick="open_modal(this)">Ideal hours per
                                            week?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Open to jobs with no guaranteed hours?"
                                            data-placeholder="Enter Guaranteed Hours" data-name="worker_guaranteed_hours"
                                            onclick="open_modal(this)">Open to jobs with no guaranteed hours?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Preferred hours per shift"
                                            data-placeholder="Enter number Of Hours/Shift" data-name="worker_hours_shift"
                                            onclick="open_modal(this)">Preferred hours per shift</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="How many weeks?"
                                            data-placeholder="Enter prefered weeks per assignment"
                                            data-name="worker_weeks_assignment" onclick="open_modal(this)">How many weeks?
                                        </p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Ideal shifts per week"
                                            data-placeholder="Enter ideal shift per week" data-name="worker_shifts_week"
                                            onclick="open_modal(this)">Ideal shifts per week</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input" data-title="# of people you have referred?"
                                            data-placeholder="# of people you have referred?"
                                            data-name="worker_referral_bonus" onclick="open_modal(this)"># of people you
                                            have referred?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="What kind of bonus do you expect?"
                                            data-placeholder="What kind of bonus do you expect?"
                                            data-name="worker_sign_on_bonus" onclick="open_modal(this)">What kind of bonus
                                            do you expect?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="What kind of bonus do you deserve?"
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="What are you comparing this to?"
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Other bonuses you want?"
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="How much do you want this?"
                                            data-filter="401k" data-name="how_much_k" onclick="open_modal(this)">How much
                                            do you want this?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="How much do you want this?"
                                            data-filter="HealthInsurance" data-name="worker_health_insurance"
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="How much do you want this?"
                                            data-filter="Dental" data-name="worker_dental" onclick="open_modal(this)">How
                                            much do you want this?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="dropdown" data-title="How much do you want this?"
                                            data-filter="Vision" data-name="worker_vision" onclick="open_modal(this)">How
                                            much do you want this?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="binary" data-title="Will you do call?" data-name="worker_on_call"
                                            onclick="open_modal(this)">Will you do call?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="binary" data-title="Is this rate reasonable?"
                                            data-name="worker_call_back" onclick="open_modal(this)">Is this rate
                                            reasonable?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Is this rate reasonable?" data-placeholder="-"
                                            data-name="worker_orientation_rate" onclick="open_modal(this)">Is this rate
                                            reasonable?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
            ...
            <p>?</p>
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="What range is reasonable?"
                                            data-placeholder="What range is reasonable?"
                                            data-name="worker_organization_weekly_amount" onclick="open_modal(this)">What
                                ...
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    ...
                                    <li>
                                        <p data-target="input" data-title="Are you going to duplicate expenses?"
                                            data-placeholder="Weekly non-taxable amount"
                                            data-name="worker_weekly_non_taxable_amount" onclick="open_modal(this)">Are
                                            you going to duplicate expenses?</p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                                    ...
                                    <li>
                                        <p data-target="input"
                                            data-title="You have 5 days left before your rate drops form 5% to 2%"
                                            data-placeholder="Goodwork Weekly Amount"
                                            data-name="worker_goodwork_weekly_amount" onclick="open_modal(this)">You have
                                            5 days left before your rate drops form 5% to 2% </p>
                                    </li>
                                </ul>
                                <ul class="ss-s-jb-apl-on-inf-txt-ul">
                                    <li>
                ...
                <div class="modal-dialog modal-sm modal-dialog-centered">
                    <div class="modal-content">
                        <div class="ss-pop-cls-vbtn">
                            <button type="button" class="btn-close" data-target="#file_modal"
