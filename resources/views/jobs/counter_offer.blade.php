      ...
      <div class="ss-form-group">
                ...
                <div class="ss-count-profsn-lins-dv">
                  <ul>
                    ...
                    <li> <input type="checkbox" id="AutoOffers" name="AutoOffers" value="Bike"> <label for="AutoOffers">Compact</label></li>
                  </ul>
                  <select name="cars" id="cars">
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="min title of reference">
                </div>
                ...
                <div class="ss-counter-immu-plus-div">
                  <ul>
                    <li>
                      <input type="text" name="Enter Vacc. or Immu. name" placeholder="Enter Certification">
                    </li>
                    <li><div class="ss-prsn-frm-plu-div"><a href=""><i class="fa fa-plus" aria-hidden="true"></i></a></div></li>
                  </ul>
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter # of Positions Available">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter # of Submissions in VMS">
                </div>

                <div class="ss-form-group">
                  <label>Block scheduling</label>
                  <input type="text" name="number of references" placeholder="Enter Block scheduling">
                </div>

                <div class="ss-form-group">
                  <label>Float requirements</label>
                  <input type="text" name="number of references" placeholder="Enter Float requirements">
                </div>

                <div class="ss-form-group">
                  <label>Facility Shift Cancellation Policy</label>
                  <input type="text" name="number of references" placeholder="Enter Facility Shift Cancellation Policy">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter Contract Termination Policy">
                </div>

                <div class="ss-form-group">
                  <label>Traveler Distance From Facility</label>
                  <input type="text" name="number of references" placeholder="Enter Traveler Distance From Facility">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter Facility's Parent System">
                </div>

                <div class="ss-form-group">
                  <label>Facility Average Rating</label>
                  <input type="text" name="number of references" placeholder="Enter Facility Average Rating">
                </div>

                <div class="ss-form-group">
                  <label>Recruiter Average Rating</label>
                  <input type="text" name="number of references" placeholder="Enter Recruiter Average Rating">
                </div>

                <div class="ss-form-group">
                  <label>Employer Average Rating</label>
                  <input type="text" name="number of references" placeholder="Enter Employer Average Rating">
                </div>

                <div class="ss-form-group">
                  <label>Clinical Setting</label>
                  <input type="text" name="number of references" placeholder="What setting do you prefer?">
                </div>

                <div class="ss-form-group">
                  <label>Patient ratio</label>
                  <input type="text" name="number of references" placeholder="How many patients can you handle?">
                </div>

                <div class="ss-form-group">
                  <label>Clinical Setting</label>
                  <input type="text" name="number of references" placeholder="Enter Clinical Setting">
                </div>

                <div class="ss-form-group">
                  <label>EMR</label>
                  <input type="text" name="number of references" placeholder="What EMRs have you used?">
                </div>
                ...
                <div class="ss-count-strt-dte ss-count-profsn-lins-dv">
                  <ul>
                    ...
                    <li> <input type="checkbox" id="AutoOffers" name="AutoOffers" value="Bike"> <label for="AutoOffers">As soon As Posible</label></li>
                  </ul>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter Guaranteed Hours">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter Completion Bonus">
                </div>

                <div class="ss-form-group">
                  <label>Extension Bonus</label>
                  <input type="text" name="number of references" placeholder="Enter Extension Bonus">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" name="number of references" placeholder="Enter Orientation Rate">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" id="Employer Weekly Amount" name="Employer Weekly Amount" placeholder="---">
                </div>

                <div class="ss-form-group">
                  <label>Goodwork Weekly Amount</label>
                  <input type="text" id="Goodwork Weekly Amount" name="Goodwork Weekly Amount" placeholder="---">
                </div>

                <div class="ss-form-group">
                  <label>Total Employer Amount</label>
                  <input type="text" id="Total Employer Amount" name="Total Employer Amount" placeholder="---">
                </div>

                <div class="ss-form-group">
                  <label>Total Goodwork Amount</label>
                  <input type="text" id="Total Goodwork Amount" name="Total Goodwork Amount" placeholder="---">
                </div>
                ...
                <div class="ss-form-group">
                  ...
                  <input type="text" id="Goodwork Number" name="Goodwork Number" placeholder="Unique Key">
                </div>
