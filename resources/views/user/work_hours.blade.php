...
<form action="{{route('my-profile')}}" class="redirect-after-submit">
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_orientation_rate" value="{{$model->worker_orientation_rate}}" placeholder="-">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_weekly_taxable_amount" value="{{$model->worker_weekly_taxable_amount}}" placeholder="Are you going to duplicate expenses?">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_weekly_non_taxable_amount" value="{{$model->worker_weekly_non_taxable_amount}}" placeholder="Are you going to duplicate expenses?">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_employer_weekly_amount" value="{{$model->worker_employer_weekly_amount}}" placeholder="What range is reasonable?">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_goodwork_weekly_amount" value="{{$model->worker_goodwork_weekly_amount}}" placeholder="you only have (count down time) left before your rate drops from 5% to 2%">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_total_employer_amount" value="{{$model->worker_total_employer_amount}}" placeholder="-">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_total_goodwork_amount" value="{{$model->worker_total_goodwork_amount}}" placeholder="How would you spend those extra funds?">
        </div>
    </div>
    ...
    <div class="ss-form-live-location">
        ...
        <input type="text" name="worker_total_contract_amount" value="{{$model->worker_total_contract_amount}}" placeholder="--">
        </div>
    </div>
    ...
    <div class="ss-prsn-form-btn-sec">
        <button type="button" class="ss-prsnl-skip-btn" id="skip-button" data-href="{{route('vaccination')}}" onclick="redirect_to(this)"> Skip </button>
