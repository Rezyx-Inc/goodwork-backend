...
class WorkerController extends Controller
{
    ...
    public function workerHomeScreen(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($user_info->count() > 0) {
                ...
                $result['total_amount'] = isset($nurse['worker_organization_weekly_amount']) ? $nurse['worker_organization_weekly_amount'] : '';
    ...
    public function graphHomeScreen(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (!isset($request->user_id)) {
                ...
                $result['total_organization_amount'] = '';
            ...
            if ($user_info->count() > 0) {
                ...
                $result['total_organization_amount'] = isset($nurse['worker_total_organization_amount']) ? $nurse['worker_total_organization_amount'] : '';
    ...
    public function workerInfo(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (isset($worker)) {
                ...
                // Basic Info
                if (isset($worker->credential_title)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->credential_title = "";
                }
                if (isset($worker->highest_nursing_degree)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->highest_nursing_degree = "";
                }
                ...
                if (isset($worker->license_type)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->license_type = "";
                }
                // Skills checklist
                if (isset($worker->diploma)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->diploma = "";
                }
                if (isset($worker->driving_license)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->driving_license = "";
                }
                if (isset($worker->recent_experience)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->recent_experience = "";
                }
                if (isset($worker->worked_at_facility_before)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worked_at_facility_before = "";
                }
                if (isset($worker->worker_ss_number)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_ss_number = "";
                }
                if (isset($worker->eligible_work_in_us)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->eligible_work_in_us = "";
                }
                if (isset($worker->skills_checklists)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->skills_checklists = "";
                }
                // Urgency
                if (isset($worker->worker_urgency)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_urgency = "";
                }
                if (isset($worker->available_position)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->available_position = "";
                }
                if (isset($worker->MSP)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                ...
                if (isset($worker->submission_VMS)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->submission_VMS = "";
                }
                if (isset($worker->block_scheduling)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->block_scheduling = "";
                }
                // Float requirement
                if (isset($worker->float_requirement)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->float_requirement = "";
                }
                if (isset($worker->facility_shift_cancelation_policy)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->facility_shift_cancelation_policy = "";
                }
                if (isset($worker->contract_termination_policy)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->contract_termination_policy = "";
                }
                if (isset($worker->distance_from_your_home)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->distance_from_your_home = "";
                }
                if (isset($worker->facilities_you_like_to_work_at)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->facilities_you_like_to_work_at = "";
                }
                if (isset($worker->worker_facility_parent_system)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_facility_parent_system = "";
                }
                if (isset($worker->avg_rating_by_facilities)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->avg_rating_by_facilities = "";
                }
                if (isset($worker->worker_avg_rating_by_recruiters)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_avg_rating_by_recruiters = "";
                }
                if (isset($worker->worker_avg_rating_by_organizations)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_avg_rating_by_organizations = "";
                }
                if (isset($worker->clinical_setting_you_prefer)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->clinical_setting_you_prefer = "";
                }
                // Patient Ratio
                if (isset($worker->worker_patient_ratio)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_patient_ratio = "";
                }
                if (isset($worker->worker_emr)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_emr = "";
                }
                if (isset($worker->worker_unit)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_unit = "";
                }
                if (isset($worker->worker_department)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_department = "";
                }
                if (isset($worker->worker_bed_size)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_bed_size = "";
                }
                if (isset($worker->worker_trauma_level)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_trauma_level = "";
                }
                if (isset($worker->worker_scrub_color)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_scrub_color = "";
                }
                if (isset($worker->worker_facility_city)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_facility_city = "";
                }
                if (isset($worker->worker_facility_state_code)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_facility_state_code = "";
                }
                // Interview dates
                if (isset($worker->worker_interview_dates)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_interview_dates = "";
                }
                if (isset($worker->worker_start_date)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_start_date = "";
                }
                if (isset($worker->worker_shift_time_of_day)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_shift_time_of_day = "";
                }
                if (isset($worker->worker_hours_per_week)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_hours_per_week = "";
                }
                if (isset($worker->worker_guaranteed_hours)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_guaranteed_hours = "";
                }
                if (isset($worker->worker_hours_shift)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_hours_shift = "";
                }
                if (isset($worker->worker_weeks_assignment)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_weeks_assignment = "";
                }
                if (isset($worker->worker_shifts_week)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_shifts_week = "";
                }
                if (isset($worker->worker_referral_bonus)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_referral_bonus = "";
                }
                // Worker Bonus
                if (isset($worker->worker_sign_on_bonus)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_sign_on_bonus = 0;
                }
                if (isset($worker->worker_completion_bonus)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_completion_bonus = 0;
                }
                if (isset($worker->worker_extension_bonus)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_extension_bonus = 0;
                }
                if (isset($worker->worker_other_bonus)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_other_bonus = 0;
                }
                if (isset($worker->how_much_k)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->how_much_k = "";
                }
                if (isset($worker->worker_health_insurance)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_health_insurance = "";
                }
                if (isset($worker->worker_dental)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_dental = "";
                }
                if (isset($worker->worker_vision)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_vision = "";
                }
                if (isset($worker->worker_actual_hourly_rate)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_actual_hourly_rate = "";
                }
                // Feels $/hr
                if (isset($worker->worker_overtime)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_overtime = "";
                }
                if (isset($worker->worker_holiday)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_holiday = "";
                }
                if (isset($worker->worker_on_call)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_on_call = "";
                }
                if (isset($worker->worker_call_back)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_call_back = "";
                }
                if (isset($worker->worker_orientation_rate)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_orientation_rate = "";
                }
                if (isset($worker->worker_weekly_taxable_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_weekly_taxable_amount = 0;
                }
                if (isset($worker->worker_weekly_non_taxable_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_weekly_non_taxable_amount = 0;
                }
                if (isset($worker->worker_organization_weekly_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_organization_weekly_amount = 0;
                }
                if (isset($worker->worker_goodwork_weekly_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_goodwork_weekly_amount = 0;
                }
                if (isset($worker->worker_total_organization_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_total_organization_amount = 0;
                }
                if (isset($worker->worker_total_goodwork_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_total_goodwork_amount = 0;
                }
                if (isset($worker->worker_total_contract_amount)) {
                    $basic_profile_comp = $basic_profile_comp + 0.373;
                } else {
                    $worker->worker_total_contract_amount = 0;
                }
                // check null or not
                ...
                $worker->worker_organization_weekly_amount = isset($worker->worker_organization_weekly_amount) ? $worker->worker_organization_weekly_amount : 0;
    ...
    public function workerFacilityInfo(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (isset($worker)) {
                ...
                $worker->worker_avg_rating_by_organizations = isset($request->worker_avg_rating_by_organizations) ? $request->worker_avg_rating_by_organizations : $worker->worker_avg_rating_by_organizations;
                ...
                if ($worker->worker_avg_rating_by_organizations == 'NA') {
                    $worker->worker_avg_rating_by_organizations = 0;
                }
                $nurse_update = NURSE::where(['id' => $worker->id])
                    ->update([
                        ...
                        'worker_avg_rating_by_organizations' => $worker->worker_avg_rating_by_organizations,
    ...
    public function workerFeelsLikeHour(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (isset($worker)) {
                ...
                $worker->worker_organization_weekly_amount = $worker->worker_weekly_taxable_amount + $worker->worker_weekly_non_taxable_amount;
                $worker->worker_goodwork_weekly_amount = $worker->worker_organization_weekly_amount * 0.05;
                $worker->worker_total_organization_amount = ($worker->worker_weeks_assignment * $worker->worker_organization_weekly_amount) + $worker->worker_sign_on_bonus + $worker->worker_completion_bonus;
                $worker->worker_total_goodwork_amount = $worker->worker_weeks_assignment * $worker->worker_goodwork_weekly_amount;
                $worker->worker_total_contract_amount = $worker->worker_total_organization_amount + $worker->worker_total_goodwork_amount;
                if ($worker->worker_hours_per_week == 0) {
                    $worker->worker_feels_like_hour = 0;
                } else {
                    $worker->worker_feels_like_hour = $worker->worker_organization_weekly_amount / $worker->worker_hours_per_week;
                }
                $nurse_update = NURSE::where(['id' => $worker->id])
                    ->update([
                        ...
                        'worker_organization_weekly_amount' => $worker->worker_organization_weekly_amount,
                        'worker_goodwork_weekly_amount' => $worker->worker_goodwork_weekly_amount,
                        'worker_total_organization_amount' => $worker->worker_total_organization_amount,
        ...
        if ($validator->fails()) {
            ...
            if ($user_info->count() > 0) {
                ...
                if ($nurse_info->count() > 0) {
                    ...
                    if (isset($request->serving_preceptor) && $request->serving_preceptor != "")
                        $nurse_array['serving_preceptor'] = $request->serving_preceptor;
                    else
                        $nurse_array['serving_preceptor'] = "0";
                    if (isset($request->serving_interim_nurse_leader) && $request->serving_interim_nurse_leader != "")
                        $nurse_array['serving_interim_nurse_leader'] = $request->serving_interim_nurse_leader;
                    else
                        $nurse_array['serving_interim_nurse_leader'] = "0";
                    if (isset($request->clinical_educator) && $request->clinical_educator != "")
                        $nurse_array['clinical_educator'] = $request->clinical_educator;
                    else
                        $nurse_array['clinical_educator'] = "0";
                    if (isset($request->is_daisy_award_winner) && $request->is_daisy_award_winner != "")
                        $nurse_array['is_daisy_award_winner'] = $request->is_daisy_award_winner;
                    else
                        $nurse_array['is_daisy_award_winner'] = "0";
                    if (isset($request->employee_of_the_mth_qtr_yr) && $request->employee_of_the_mth_qtr_yr != "")
                        $nurse_array['employee_of_the_mth_qtr_yr'] = $request->employee_of_the_mth_qtr_yr;
                    else
                        $nurse_array['employee_of_the_mth_qtr_yr'] = "0";
                    if (isset($request->other_nursing_awards) && $request->other_nursing_awards != "")
                        $nurse_array['other_nursing_awards'] = $request->other_nursing_awards;
                    else
                        $nurse_array['other_nursing_awards'] = "0";
                    if (isset($request->is_professional_practice_council) && $request->is_professional_practice_council != "")
                        $nurse_array['is_professional_practice_council'] = $request->is_professional_practice_council;
                    else
                        $nurse_array['is_professional_practice_council'] = "0";
                    if (isset($request->is_research_publications) && $request->is_research_publications != "")
                        $nurse_array['is_research_publications'] = $request->is_research_publications;
                    else
                        $nurse_array['is_research_publications'] = "0";
                    if (isset($request->leadership_roles) && $request->leadership_roles != "")
                        $nurse_array['leadership_roles'] = $request->leadership_roles;
                    if (isset($request->languages) && $request->languages != "")
                        $nurse_array['languages'] = $request->languages;
                    if (isset($request->summary) && $request->summary != "")
                        $nurse_array['summary'] = $request->summary;
                    /* if (isset($request->languages) && $request->languages) {
                    ...
                    if ($additional_photos = $request->file('additional_pictures')) {
                        foreach ($additional_photos as $additional_photo) {
                            ...
                            if ($additional_pictures_insert)
                                $additional_pictures_status = true;
                        }
                    }
                    ...
                    if ($additional_files = $request->file('additional_files')) {
                        foreach ($additional_files as $additional_file) {
                            ...
                            if ($additional_files_insert)
                                $additional_files_status = true;
                        }
                    }
        ...
        if ($validator->fails()) {
            ...
            if ($worker_info->count() > 0) {
                ...
                if ($user_info->count() > 0) {
                    ...
                    if ($job['profession'] == $job_data['highest_nursing_degree']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job_data['nursing_license_state'] == $job['job_location']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job_data['eligible_work_in_us'] == 'yes') {
                        $eligible_work_in_us = true;
                    } else {
                        $eligible_work_in_us = false;
                    }
                    ...
                    if ($job_data['worker_float_requirement'] == 'Yes') {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['traveler_distance_from_facility'] == $job_data['distance_from_your_home']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if (isset($job_data['worker_avg_rating_by_organizations']) && ($job_data['worker_avg_rating_by_organizations'] != 0)) {
                        $data['worker'] = $job_data['worker_avg_rating_by_organizations'];
                    } else {
                        $data['worker'] = "";
                    }
                    $data['job'] = isset($job['organization_average_rating']) ? $job['organization_average_rating'] : "";
                    $data['match'] = !empty($job_data['worker_avg_rating_by_organizations']) ? true : false;
                    // $data['worker'] = isset($job_data['worker_avg_rating_by_organizations'])?$job_data['worker_avg_rating_by_organizations']:"";
                    $data['name'] = 'organization average rating';
                    $data['match_title'] = 'Organization Average Rating';
                    $data['update_key'] = 'worker_avg_rating_by_organizations';
                    $data['type'] = 'input';
                    $data['worker_title'] = 'Your average rating by your organizations';
                    $data['job_title'] = !empty($job['organization_average_rating']) ? $job['organization_average_rating'] : 'Organization Average Rating';
                    $worker_info[] = $data;

                    if ($job['clinical_setting'] == $job_data['clinical_setting_you_prefer']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['scrub_color'] == $job_data['worker_scrub_color']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['job_state'] == $job_data['worker_facility_state_code']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['job_city'] == $job_data['worker_facility_city']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['preferred_shift'] == $job_data['worker_shift_time_of_day']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['hours_per_week'] == $job_data['worker_hours_per_week']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['guaranteed_hours'] == $job_data['worker_guaranteed_hours']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['hours_shift'] == $job_data['worker_hours_shift']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['preferred_assignment_duration'] == $job_data['worker_weeks_assignment']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['weeks_shift'] == $job_data['worker_shifts_week']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['referral_bonus'] == $job_data['worker_referral_bonus']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if (($job['sign_on_bonus'] == $job_data['worker_sign_on_bonus']) && (!empty($job_data['worker_sign_on_bonus']))) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['completion_bonus'] == $job_data['worker_completion_bonus']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['extension_bonus'] == $job_data['worker_extension_bonus']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['actual_hourly_rate'] == $job_data['worker_actual_hourly_rate']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['feels_like_per_hour'] == $job_data['worker_feels_like_hour']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['weekly_taxable_amount'] == $job_data['worker_weekly_taxable_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['weekly_non_taxable_amount'] == $job_data['worker_weekly_non_taxable_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['organization_weekly_amount'] == $job_data['worker_organization_weekly_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    $data['job'] = isset($job['organization_weekly_amount']) ? $job['organization_weekly_amount'] : "";
                    $data['match'] = $val;
                    $data['worker'] = isset($job_data['worker_organization_weekly_amount']) ? $job_data['worker_organization_weekly_amount'] : "";
                    $data['name'] = 'Organization Weekly Amount';
                    $data['match_title'] = 'Organization Weekly Amount';
                    $data['update_key'] = 'worker_organization_weekly_amount';
                    $data['type'] = 'input';
                    $data['worker_title'] = 'What range is reasonable?';
                    $data['job_title'] = !empty($data['job']) ? $data['job'] : 'Organization Weekly Amount';
                    $worker_info[] = $data;

                    if ($job['goodwork_weekly_amount'] == $job_data['worker_goodwork_weekly_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['total_organization_amount'] == $job_data['worker_total_organization_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    $data['job'] = isset($job['total_organization_amount']) ? $job['total_organization_amount'] : "";
                    $data['match'] = $val;
                    $data['worker'] = isset($job_data['worker_total_organization_amount']) ? $job_data['worker_total_organization_amount'] : "";
                    $data['name'] = 'Total Organization Amount';
                    $data['match_title'] = 'Total Organization Amount';
                    $data['update_key'] = 'worker_total_organization_amount';
                    $data['type'] = 'input';
                    $data['worker_title'] = '';
                    $data['job_title'] = !empty($data['job']) ? $data['job'] : 'Total Organization Amount';
                    $worker_info[] = $data;

                    if ($job['total_goodwork_amount'] == $job_data['worker_total_goodwork_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
                    ...
                    if ($job['total_contract_amount'] == $job_data['worker_total_contract_amount']) {
                        $val = true;
                    } else {
                        $val = false;
                    }
    ...
    public function workerInformationSkip(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($job['profession'] == (isset($job_data['highest_nursing_degree']) ? $job_data['highest_nursing_degree'] : "")) {
                $val = true;
            } else {
                $val = false;
            }
            ...
            if (isset($job_data['eligible_work_in_us']) ? $job_data['eligible_work_in_us'] : "" == 'yes') {
                $eligible_work_in_us = true;
            } else {
                $eligible_work_in_us = false;
            }
            ...
            if ($job['traveler_distance_from_facility'] == $data['worker']) {
                $val = true;
            } else {
                $val = false;
            }
            ...
            if ($job['preferred_assignment_duration'] == '') {
                $val = true;
            } else {
                $val = false;
            }
            ...
            if ($job['weekly_non_taxable_amount'] == '') {
                $val = true;
            } else {
                $val = false;
            }
            ...
            if ($job['organization_weekly_amount'] == '') {
                $val = true;
            } else {
                $val = false;
            }
            ...
            if ($job['total_organization_amount'] == '') {
                $val = true;
            } else {
                $val = false;
            }
    ...
    public function updateWorkerInformation(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($worker_info->count() > 0) {
                ...
                $worker->worker_organization_weekly_amount = isset($request->worker_organization_weekly_amount) ? $request->worker_organization_weekly_amount : $worker->worker_organization_weekly_amount;
                ...
                $worker->worker_total_organization_amount = isset($request->worker_total_organization_amount) ? $request->worker_total_organization_amount : $worker->worker_total_organization_amount;
